---
title: Visual Studio aboneliklerinde Microsoft 365 Geliştirici aboneliği avantajı | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: lank
ms.assetid: ''
...
Microsoft 365 E5 geliştirici aboneliğine nelerin dahil olduğunu görmek için, bkz. [Microsoft 365 Geliştirici Programı SSS](https://docs.microsoft.com/office/developer-program/microsoft-365-developer-program-faq#whats-included-in-the-developer-subscription).
...
- [Posta kutularını bir Microsoft 365 kiracısından diğerine geçirme](https://docs.microsoft.com/exchange/mailbox-migration/migrate-mailboxes-across-tenants)
- [Office 365 ' e hazırlanan bir geçiş gerçekleştirmek için PowerShell 'i kullanma](https://docs.microsoft.com/office365/enterprise/powershell/use-powershell-to-perform-a-staged-migration-to-office-365)
- [Office 365 Microsoft 365 geçiş kılavuzu](https://docs.microsoft.com/sharepointmigration/mover-o365-to-o365) Microsoft 365 Geliştirici programında üyeliğiniz için teşekkür ederiz.
...
- Microsoft 365 Geliştirici aboneliğiyle ilgili yardıma mı ihtiyacınız var?  Çevrimiçi [Microsoft 365 belgelerine](https://docs.microsoft.com/office/developer-program/office-365-developer-program-faq)göz atın.
...
- ' Da oturum açın https://my.visualstudio.com/benefits ve başlamak için Microsoft 365 Geliştirici aboneliği kutucuğuna tıklayın. 
