...
<sup>1</sup>  *şunları Içerir: for SATıM (NFR), Visual Studio sektör ortağı (VSıP), FTE, BIZSPARK, mct Software & Services geliştiricisi. Dışlar: MCT Software & Services, Microsoft İş Ortağı Ağı (MPN), Imagine, en değerli profesyonel (MVP), bölgesel yönetmen (RD), NFR Basic.*
