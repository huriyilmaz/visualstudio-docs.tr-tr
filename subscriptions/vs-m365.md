...
0. Hoş Geldiniz ekranında bölgenizi/ülkenizi seçin, şirketinizin adını girin ve kullanım koşullarını kabul etmek için onay kutusuna tıklayın.  Sonra **İleri**'ye tıklayın.
...
0. **Geliştirici aboneliğinizi ayarlama** iletişim kutusunda ülkenizi seçin, Kullanıcı adınızı ve etki alanınızı oluşturun ve parolanızı ayarlayın.  Sonra **devam**' a tıklayın.
...
### <a name="q-how-do-current-users-upgrade-to-e5"></a>S: geçerli kullanıcılar E5 'e nasıl yükseltilir?
...
### <a name="q-can-i-activate-microsoft-365-using-an-existing-tenant-or-do-i-need-to-create-a-new-one"></a>S: var olan bir kiracıyı kullanarak Microsoft 365 etkinleştirebilir veya yenisini oluşturmem gerekebilir mi?
...
### <a name="q-if-microsoft-365-doesnt-include-windows-how-do-i-get-windows"></a>S: Microsoft 365 Windows içermiyorsa, Windows 'u nasıl edinebilirim?
...
- https://my.visualstudio.com/benefits oturum açın ve başlamak için Microsoft 365 kutucuğuna tıklayın. 
