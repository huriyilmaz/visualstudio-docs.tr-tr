---
title: Visual Studio aboneliklerde Microsoft Azure avantaj | Microsoft Docs
author: evanwindom
ms.author: cabuschl
manager: cabuschl
...
Visual Studio aboneliğinizin süresi dolarsa veya kaldırılırsa, aylık Azure geliştirme/test kredisi dahil olmak üzere tüm abonelik avantajları artık kullanılamaz. Azure 'u aylık krediyle kullanmaya devam etmek için aboneliğinizi yenilemeniz, yeni bir abonelik satın almanız ve/veya Azure kaynaklarınızı Azure dev/test bireysel kredisi içeren farklı bir Azure aboneliğine aktarmanız gerekir.  
...
|--------------------------------------------------------------|-----------------------------|-------------------------------------------------------------|
|              Visual Studio Enterprise Stand               |     $150 aylık kredi     |                             Yes                             |
|              GitHub Enterprise aboneliği Visual Studio Enterprise               |     $150 aylık kredi     |                             Yes                             |
|               Visual Studio Enterprise aylık               |        Kullanılamaz        |                                                             |
|             Visual Studio Professional Stand              |     $50 aylık kredi      |                             Yes
|              GitHub Enterprise aboneliği Visual Studio Professional              |     $50 aylık kredi     |                             Yes                             |
...
<sup>1</sup>*dahildir: for satılamaz (nfr), en değerli Professional (MVP), bölgesel yönetmen (RD), Visual Studio sektör ortağı (vsıp) hariç tutar: nfr Basic*  
