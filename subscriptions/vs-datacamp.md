...
| Subscription Level                                                 |     Kanallar                                            | Faydası                                                          | Renewable?    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, Retail, | 3-months       |  Hayır.  Available to new subscribers only          |
| Visual Studio Enterprise with GitHub Enterprise   | VL | 3-months       |  Hayır.  Available to new subscribers only          |
| Visual Studio Professional (Standard) | VL, Azure, Retail                                       | 3-months                                                            |  Hayır.  Available to new subscribers only           |
| Visual Studio Professional with GitHub Enterprise| VL | 3-months                                                            |  Hayır.  Available to new subscribers only           |
| Visual Studio Test Professional (Standard)                         | VL, Retail                                              | 3-months                                             |  Hayır.  Available to new subscribers only           |
| MSDN Platforms (Standard)                                          | VL, Retail                                              | 3-months                                              |  Hayır.  Available to new subscribers only           |
| Visual Studio Enterprise (Standard)  | NFR<sup>1</sup> |Yok  | Yok |
| Visual Studio Enterprise, Visual Studio Professional (monthly cloud) | Azure | Yok | Yok |
