...
> [!NOTE]
> Bu bilgiler Mac IDE için Visual Studio içindir. Visual Studio Code için daha fazla bilgi için [bu kılavuza](https://code.visualstudio.com/docs/other/unity) bakın.
...
### <a name="roslyn-diagnostics-and-quick-fixes-for-unity"></a>Birlik için Roslyn tanılama ve hızlı düzeltmeler

Mac'in Unity projelerini derinlemesine anlamak için Visual Studio ile en iyi uygulamaları yakalayan daha iyi kodyazın. 

![Vs Mac refactoring dize compareTag ile karşılaştırın](media/using-vsmac-tools-unity-image9.png)
