...
Mac için Visual Studio Windows Visual Studio aynı editör katmanları üstüne inşa [yeni bir yerli Kakao metin editörü UI tanıttı.](https://docs.microsoft.com/visualstudio/releasenotes/vs2019-mac-relnotes)
