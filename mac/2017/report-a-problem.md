...
1. Karşılaştığınız sorunu bulamazsanız, ekranın yanında **Yeni bir sorun bildir** ' i seçin.
   ...
   > [!NOTE]
   > **yeni bir sorun bildir** düğmesi yalnızca geliştirici Community Mac için Visual Studio arabiriminde görüntülenir. doğrudan [geliştirici Community](https://aka.ms/feedback/report?space=41/) web sitesinde sorun bildiremiyoruz.
