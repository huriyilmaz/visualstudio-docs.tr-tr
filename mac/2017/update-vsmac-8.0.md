...
Mac için Visual Studio 2019, birçok yeni geliştirme sunar: yepyeni bir C# düzenleyici, yeni bir başlangıç deneyimi, birden çok örnek için destek ve Xamarin, Unity ve .NET Core geliştiricileri için yeni iyileştirmeler geliştirme. Mac için Visual Studio 2019 ' ye dahil olan her şey hakkında daha fazla bilgi için aşağıdaki blog gönderilerine göz atın:
