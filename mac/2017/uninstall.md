...
Mac için Visual Studio gibi bağımsız uygulamalar da dahil olmak üzere, platformlar arası uygulama geliştirmeyi sağlayan bir dizi Xamarin ürünü vardır.

Bu kılavuzu, ilgili bölüme gezinerek her ürünü tek tek kaldırmak için kullanabilir veya Her şeyi kaldırmak için [Komut Dosyasını Kaldır](#uninstall-script) bölümünde sağlanan komut dosyalarını kullanabilirsiniz.
...
4. Son olarak, kaldır komut dosyasını silin.
