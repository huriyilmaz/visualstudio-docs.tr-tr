...
# [Web Uygulaması Dağıtımı](/visualstudio/mac/web-app-deployment)
## [Azure App Service’e yayımlama](/visualstudio/mac/publish-app-svc)
## [Klasöre Yayımlama](/visualstudio/mac/publish-folder)
