...
- En sağdaki kapanış parantezleri ekleyin.  
    ...
    > [!NOTE]
    > Tek bir parantezle eşleştirmek istiyorsanız, bir ters eğik çizgiyle kaçış- \\ (-, bu nedenle özel bir karakter olarak yorumlanmaması için) [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] .  
