...
titleSuffix: ''
description: komut satırından Visual Studio yüklemek veya vsıx bildiriminde bir bağımlılık belirtmek için Visual Studio Professional iş yükü ve bileşen kimlikleri kullanın.
keywords: ''
author: anandmeg
