...
Aşağıdaki adımlar tipik bir çevrimiçi yükleme için en iyi duruma getirilmiştir. Çevrimdışı yüklemeyi etkileyen bir sorun için bkz. [Çevrimdışı yükleme sorunlarını giderme.](#offline-installations)
...
Bu Visual Studio Yükleyicisi önyükleyici, uygulamanın geri kalanını yüken küçük bir hafif yürütülebilir Visual Studio Yükleyicisi. Dosya Visual Studio Yükleyicisi ve ardından önyükleyiciyi yeniden çalıştırma bazı güncelleştirme hatalarını çözebilir.
...
| Yeni iş yükleri, bileşenler veya diller yük devretmez.  | `--layout`  | Kısmi bir düzenden yükleniyorsa ve daha önce bu kısmi düzende indirilemedi iş yüklerini, bileşenleri veya dilleri seçerek İnternet erişiminiz olduğundan emin olun. |
