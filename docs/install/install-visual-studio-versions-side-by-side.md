...
1. Visual Studio 2022 önyükleyici dosyasını [Visual Studio indirmeleri sayfasından](https://visualstudio.microsoft.com/downloads) veya mevcut Visual Studio sürümü ile yan yana yüklemek istediğiniz ikincil sürümün [Visual Studio 2022 yayınları](/visualstudio/releases/2022/history) sayfasından indirin.
