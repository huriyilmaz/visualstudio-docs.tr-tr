...
> [!IMPORTANT]
> Bu yönergelerde, daha önce bir ağ yükleme düzeni oluşturduğunuz ve istemcinin güncelleştirmeleri nasıl aldıracakları konusunda bazı kararlar alasınız. Bunun nasıl olduğu hakkında daha fazla bilgi için Ağ yüklemesi oluşturma [Visual Studio](create-a-network-installation-of-visual-studio.md) dağıtımları için [güncelleştirmeleri Visual Studio sayfasına](../install/controlling-updates-to-visual-studio-deployments.md) bakın.
