...
Ayrıca, *% ProgramFiles (x86)% \ Microsoft Visual Studio\\\<sürüm > \Enterprise\Common7\IDE\PrivateAssemblies* klasöründe bulunan LOADTESTPACKAGE dll dosyasına bir başvuru eklemeniz gerekir.
