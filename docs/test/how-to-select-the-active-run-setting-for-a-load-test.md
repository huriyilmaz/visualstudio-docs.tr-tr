...
> [!NOTE]
> @No__t_0 adlı bir ortam değişkenini ayarlayarak etkin çalışma ayarını geçersiz kılabilirsiniz. Bu, komut satırından veya bir toplu iş dosyasından bir yük testi çalıştırdığınızda yararlı olur. Bu, yük testinizi açmadan farklı çalışma ayarları seçmenize olanak sağlar.
