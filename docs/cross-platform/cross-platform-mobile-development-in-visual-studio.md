...
description: Bu makalede, android, iOS ve Windows cihazları için uygulama derlemeyi Visual Studio.
titleSuffix: ''
...
ms.locfileid: "114201773"
---
# <a name="cross-platform-mobile-development-in-visual-studio"></a>Visual Studio'de platformlar arası mobil Visual Studio

Visual Studio kullanarak Android, iOS ve Windows cihazlar için uygulama Visual Studio.  Uygulamayı tasarlarken Visual Studio, Microsoft 365, Azure App Service ve Application Analizler gibi bağlı hizmetleri kolayca eklemek için Analizler.
...
|[Visual Studio'de Xamarin](https://visualstudio.microsoft.com/xamarin/) (VisualStudio.com) hakkında bilgi|
|[Xamarin mobil uygulama geliştirme belgeleri](/xamarin/) |
|[Xamarin uygulamaları ile DevOps](/xamarin/tools/ci/devops/) |
|[Visual Studio'Windows Universal VisualStudio.com](https://visualstudio.microsoft.com/vs/universal-windows-platform/) hakkında bilgi edinin|
...
### <a name="target-android-ios-and-windows-from-a-single-code-base"></a><a name="AndroidHTML"></a>Android, iOS ve Windows tek bir kod tabanından hedefle
 ...
 Zaten yüklü bir Visual Studio varsa, Visual Studio Yükleyicisi yeniden  çalıştırın ve Xamarin için **aynı .NET** ile Mobil Geliştirme seçeneğini belirleyin (yukarıda olduğu gibi).
 ...
 Bir proje oluşturdukta, bu projenin tüm üretkenlik özelliklerinden Visual Studio. Örneğin, sayfalarınızı oluşturmak için bir tasarımcı ve mobil platformların yerel API'lerini keşfetmek için IntelliSense'i kullanırsınız. Uygulamanızı çalıştırmaya ve nasıl göründüğünü görmeye hazırsanız, Android SDK öykünücüsünü kullanabilir ve Windows çalıştırabilirsiniz. Ayrıca, bağlı Android ve cihazları doğrudan Windows kullanabilirsiniz. iOS projeleri için ağa bağlı bir Mac'e bağlanarak iOS öykünücüsünü Visual Studio veya bağlı bir cihaza bağlanabilirsiniz.
...
### <a name="target-windows-10-devices"></a><a name="WindowsHTML"></a>Hedef Windows 10 cihazları
 ...
 Tüm cihazları hedef alan tek bir uygulama oluşturmak Windows 10, evrensel bir Windows oluşturun. Uygulamayı tek bir proje kullanarak tasarlarsanız, sayfalarınız bunları görüntülemek için hangi cihaz kullanılırsa kullanın düzgün bir şekilde işler.
...
## <a name="build-an-app-for-android-ios-and-windows-htmljavascript"></a><a name="HTML"></a>Android, iOS ve Windows için uygulama oluşturma (HTML/JavaScript)
 ...
 Web geliştiricisiyseniz ve HTML ve JavaScript hakkında bilgi sahibiyseniz, Windows için Visual Studio Araçları kullanarak Windows, Android ve iOS'u Apache Cordova. Bu uygulamalar üç platformu da hedefleyenin ve en çok aşina olunan becerileri ve süreçleri kullanarak bunları geliştirebilirsiniz.

 Apache Cordova, eklenti modeli içeren bir çerçevedir. Bu eklenti modeli, üç platformun da (Android, iOS ve android) yerel cihaz özelliklerine erişmek için kullanabileceğiniz tek bir JavaScript API'si Windows.
 ...
 Uygulamalarınızı çalıştırmaya ve kodunuz üzerinde adım atmaya hazır olduğunuzda Apache Ripple öykünücüsü ya da Android Emulator, tarayıcı veya doğrudan bilgisayarınıza bağlı bir cihaz gibi bir öykünücü seçin. Ardından, uygulamanıza başlayabilirsiniz. Uygulamalarınızı bir Windows bilgisayarınızda geliştiriyorsanız, bunun üzerinde bile çalıştırabilirsiniz. Bu seçeneklerin hepsi, Visual Studio bir parçası olarak Visual Studio Araçları yerleşik Apache Cordova.

 Project Evrensel Windows Platformu (UWP) uygulamaları oluşturmaya yönelik şablonlar Visual Studio'da hala kullanılabilir. Bu nedenle, yalnızca Windows cihazları hedeflemeyi planlıyorsanız bunları kullanabilirsiniz. Daha sonra Android ve iOS'u hedeflemeye karar verdiyebilirsiniz, kodunuzu her zaman bir Cordova projesine taşınabilirsiniz.
...
![Android, iOS&#43;&#43; derlemek için C Windows](../cross-platform/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")

 İlk olarak, Visual Studio ve **C++ ile Mobil Geliştirme iş yükünü** yükleyin. Ardından, Android için yerel bir etkinlik uygulaması ya da android ya da iOS'u Windows bir uygulama derlemeniz gerekir. Android, iOS ve Windows aynı çözümde hedefleyebilirsiniz ve ardından platformlar arası statik veya dinamik paylaşılan kitaplık kullanarak bu cihazlar arasında kod paylaşabilirsiniz.
 ...
 Ayrıca C++ ve Universal Windows Platform (UWP) uygulama proje şablonunu kullanarak Windows 10 cihazların tamamını hedef alan bir uygulama da oluşturabilirsiniz. Bu konuda daha önce görünen [Hedef Windows 10 cihazlar](#WindowsHTML) bölümünde bu konu hakkında daha fazla bilgi edinebilirsiniz.
 ...
 Bu kitaplığı, bu Windows daha önce açıklananlar gibi bir Windows, iOS veya Android projesinde tüketebilirsiniz. Ayrıca, Xamarin, Java veya bir dil kullanarak derlemek için bir uygulamada veya bir unmanaged DLL'de işlevleri çağırmaya olanak sağlayan herhangi bir dilde de bunu tüketebilirsiniz.
...
|[C++ kodunu Android ve Windows uygulamalarıyla paylaşma (VisualStudio.com)](https://visualstudio.microsoft.com/vs/cplusplus-mdd/)|
...
|[Daha fazla bilgi Unity için Visual Studio Araçları](/visualstudio/gamedev/unity/get-started/visual-studio-tools-for-unity) |
|[Unity için Visual Studio Araçları](/visualstudio/gamedev/unity/get-started/getting-started-with-visual-studio-tools-for-unity) |
...
|[Unity için Visual Studio Araçları 2.0 Önizleme sürümüne giriş videosunu izleyin](https://www.bing.com/videos/search?q=visual+studio+tools+for+unity&qs=n&form=QBVLPG&pq=visual+studio+tools+for+unity&sc=6-29&sp=-1&sk=#view=detail&mid=0A13177F0BC7463A24080A13177F0BC7463A2408&preserve-view=true) (Video)|
|[Unity hakkında bilgi edinmek](https://unity.com/) (Unity web sitesi)|

## <a name="see-also"></a>Ayrıca bkz.

- [Microsoft 365 api'lerini Visual Studio ekleme](/office/developer-program/office-365-developer-program)
