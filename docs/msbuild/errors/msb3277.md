---
title: "MSB3277: ' Assembly ' öğesinin çözümlenemeyecek farklı sürümleri arasında çakışmalar bulundu."
...
Hatayı tanılamak için, önce bir tanılama günlüğünü etkinleştirin ( `-verbosity:diag` komut satırı anahtarını kullanın) ve MSBuild günlük dosyasını tam tanılama çıkışıyla kontrol edin. Bu hata, MSBuild 16. x veya üzeri bir sürümde oluştuğunda, çakışma durumunda olan belirli sürümler günlük dosyasına yazılır. MSBuild 'in daha önceki bir sürümünü kullanıyorsanız, bu günlük dosyasında değildir, ancak çakışan başvuruyu bulmak için genellikle bağımlılık zincirini takip edebilirsiniz. Projenizin başvurduğu derlemelerin her birine bakın ve bu derlemelerin başvurduğu derlemeleri ve bu derlemeler, çakışan sürümleri bulana kadar bu şekilde devam eder.
