...
|Parametre|Açıklama|
|---------------|-----------------|
|`ApplicationManifest`|Gerekli **ıtaskitem []** parametresi.<br /><br /> `<hostInBrowser />` öğesini eklemek istediğiniz uygulama bildirimi dosyasının yolunu ve adını belirtir.|
