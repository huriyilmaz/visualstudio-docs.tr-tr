...
## <a name="reserved-properties"></a>Ayrılmış Özellikler
 ...
 daha fazla bilgi için bkz. [nasıl yapılır: proje dosyasının adına veya konumuna başvurma](../msbuild/how-to-reference-the-name-or-location-of-the-project-file.md) ve [ayrılmış ve iyi bilinen özellikler MSBuild](../msbuild/msbuild-reserved-and-well-known-properties.md).
...
> [!TIP]
> Tüm ortam değişkenleri, başlangıç özellikleri olması için okunmaz. adı geçerli bir MSBuild özellik adı olmayan ("386" gibi) bir ortam değişkeni yok sayılır.
...
> [!WARNING]
> MSBuild () .net SDK sürümünde `dotnet build` , kayıt defteri özellikleri desteklenmez.
