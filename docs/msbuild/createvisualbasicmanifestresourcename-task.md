...
| `ResourceFiles` | Gerekli `String` parametresi.<br /><br /> [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] bildirim adının oluşturulacağı kaynak dosyasının adı. |
