...
## <a name="c-project-vcxproj-and-solution-sln-files"></a>C++Proje (. vcxproj) ve çözüm (. sln) dosyaları
 ...
 Hem C++ projeler ( *. vcxproj*) hem de çözüm ( *. sln*) dosyaları [MSBuild görevine](../msbuild/msbuild-task.md)geçirilebilir. Projeler C++ için VCWrapperProject çağrılır ve sonra iç MSBuild projesi oluşturulur. Çözümler C++ Için bir SolutionWrapperProject oluşturulur ve ardından iç MSBuild projesi oluşturulur. Her iki durumda da, sonuçta elde edilen proje diğer MSBuild projesiyle aynı şekilde değerlendirilir.
