...
## <a name="c-project-vcxproj-and-solution-sln-files"></a>C++Proje (. vcxproj) ve çözüm (. sln) dosyaları
 [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] projeler ( *. vcxproj*) ve çözüm ( *. sln*) dosyaları [MSBuild görevine](../msbuild/msbuild-task.md)geçirilebilir. [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] projeler için, VCWrapperProject çağrılır ve sonra iç [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] projesi oluşturulur. [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] çözümleri için bir SolutionWrapperProject oluşturulur ve sonra iç [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] projesi oluşturulur. Her iki durumda da, sonuçta elde edilen proje diğer [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] projesiyle aynı şekilde değerlendirilir.
