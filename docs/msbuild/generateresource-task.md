...
description: . Txt veya. resx dosyalarını ve ortak dil çalışma zamanı ikili. resources dosyalarını dönüştürmek için MSBuild GenerateResource görevini kullanın.
