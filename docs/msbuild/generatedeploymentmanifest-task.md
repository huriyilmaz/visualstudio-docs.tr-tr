...
ms.locfileid: "122137163"
---
# <a name="generatedeploymentmanifest-task"></a>GenerateDeploymentManifest görevi

bir ClickOnce dağıtım bildirimi oluşturur. ClickOnce dağıtım bildirimi, dağıtım için benzersiz bir kimlik tanımlayarak, uygulama güncelleştirme ayarlarını ve güncelleştirme konumlarını belirten ve karşılık gelen ClickOnce uygulama bildirimini belirten dağıtım niteliklerini tanımlayarak uygulamanın dağıtımını açıklar.
...
| `CreateDesktopShortcut` | İsteğe bağlı `Boolean` parametre.<br /><br /> doğru ise, ClickOnce uygulama yüklemesi sırasında masaüstünde bir simge oluşturulur. |
...
| `SuiteNamel` | İsteğe bağlı `String` parametre.<br /><br /> ClickOnce dağıtımdan sonra uygulamanın bulunduğu **başlangıç** menüsünde klasörün adını belirtir. |
