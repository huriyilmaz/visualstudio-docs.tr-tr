...
|**Kaynaklar**|İsteğe bağlı `ITaskItem[]` parametre.<br /><br /> Boşluklarla ayrılmış bildirim kaynak dosyalarının bir listesini belirtir.<br /><br /> Daha fazla bilgi için [Mt.exe](/windows/desktop/SbsCs/mt-exe)içindeki **/MANIFEST** seçeneğine bakın.|
