...
description: MSBuild 'in aynı projedeki türlere başvuran XAML dosyalarında ikinci geçiş biçimlendirme derlemesini gerçekleştirmek için MarkupCompilePass2 görevini nasıl kullandığını öğrenin.
