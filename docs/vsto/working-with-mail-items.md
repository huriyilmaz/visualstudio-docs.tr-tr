...
description: MailItem sınıfının, e-posta iletileriyle görevleri gerçekleştirmek için kullandığınız yöntemleri ve özellikleri içerdiğini öğrenin.
