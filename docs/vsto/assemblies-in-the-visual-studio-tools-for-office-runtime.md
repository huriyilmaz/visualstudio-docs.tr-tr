...
|Microsoft. Office. Tools. Excel. v 9.0. dll|Excel çözümleri için konak öğeleri ve konak denetimleri sağlar. Daha fazla bilgi için bkz. [genişletilmiş nesneleri kullanarak Excel 'ı otomatikleştirme](automating-excel-by-using-extended-objects.md).|
