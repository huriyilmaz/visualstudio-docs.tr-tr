...
|Bütünleştirilmiş kod adı|Description|
|-------------------|-----------------|
...
|Microsoft.VisualStudio.Tools.Office.Runtime.v10.0.dll|Aşağıdaki türleri sağlar:<br /><br /> - Microsoft.VisualStudio.Tools. Office. Runtime.Security.AddInSecurityEntry ve Microsoft.VisualStudio.Tools. Office. Runtime.Security.UserInclusionList sınıflarını kullanarak 3.5'i hedef alan Office erişim izni vermek üzere kullanıcı ekleme listesi girişleri .NET Framework.<br />- Çalışma zamanı altyapısının bir Office için Visual Studio Araçları olan ve doğrudan kodunuzdan kullanılmaya yönelik olmayan diğer türler.|
