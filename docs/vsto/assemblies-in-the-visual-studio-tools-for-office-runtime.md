...
|Bütünleştirilmiş kod adı|Description|
|-------------------|-----------------|
|Microsoft.Office.Tools.Common.v4.0.Utilities.dll|`ThisAddIn`VSTO eklenti projelerinde oluşturulan sınıf için temel sınıfları ve tüm projelerde oluşturulan Şerit sınıfını sağlar.|
