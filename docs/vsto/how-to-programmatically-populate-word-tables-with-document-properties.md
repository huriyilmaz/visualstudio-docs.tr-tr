...
## <a name="populate-tables-in-a-document-level-customization"></a>Belge düzeyi özelleştirmesindeki tabloları doldur
...
2. Tablo için bir başlık ekleyin ve paragraf işaretlerini ekleyin.
...
3. Tablodaki belgeye tablo ekleyin.
...
4. Tabloyu biçimlendirin ve bir stil uygulayın.
...
5. Belge özelliklerini hücrelere ekleyin.
   ...
   Aşağıdaki örnek, tüm prosedürü gösterir. Bu kodu kullanmak için `ThisDocument` projenizdeki sınıftan çalıştırın.
...
## <a name="populate-tables-in-a-vsto-add-in"></a>Bir VSTO eklentisinin tablolarını doldurma
...
5. Belge özelliklerini hücrelere ekleyin.
   ...
   Aşağıdaki örnek, tüm prosedürü gösterir. Bu kodu kullanmak için `ThisAddIn` projenizdeki sınıftan çalıştırın.
