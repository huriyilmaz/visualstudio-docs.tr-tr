...
1. [!INCLUDE[dsl](../modeling/includes/dsl_md.md)]görev Flow çözüm şablonunu kullanarak bir çözüm oluşturun.

2. Çözümdeki **Dsl\resources** klasörüne 16x16 piksellik bir simge içeren bir .bmp dosyası yerleştirin.

3. **DSL gezgini**' nde **gezgin davranışı** ' na sağ tıklayın ve ardından **yeni gezgin düğüm Ayarlar ekle**' ye tıklayın.

    **özel düğüm Ayarlar** düğümünün altında bir **explorernodesettings** düğümü görüntülenir.
