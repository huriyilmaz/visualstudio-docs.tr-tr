...
Varsayılan olarak, her katıştırma ilişkisi hedef rolde doğru `PropagatesDelete`. @No__t_0 silmek `familyTree` silmez, ancak `familyTree.Delete()` tüm `Persons` silecektir.
