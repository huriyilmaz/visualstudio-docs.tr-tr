...
## <a name="inheritance"></a>Devralma
 ...
 Devralma İlişkiler, Şekiller ve Bağlayıcılar arasında da kullanılabilir. Devralma aynı grup içinde kalarak devam etmek gerekir. Şekil bir etki alanı sınıfından devralamaz.
