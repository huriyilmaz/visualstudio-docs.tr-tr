...
1. Bu örnekte **Book** ve **Author**olarak adlandırılan en az iki sınıf içeren bir [!INCLUDE[dsl](../modeling/includes/dsl_md.md)] çözümü oluşturun. **Kitap** ve **Yazar**arasında her iki türden bir ilişki olmalıdır.
