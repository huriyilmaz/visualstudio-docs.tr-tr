...
- Derlemenin mutlak yolu
  ...
  gibi değişkenlere ve ortam değişkenlerine Visual Studio için söz `$(variableName)` `$(SolutionDir)` `%VariableName%` dizimi kullanabilirsiniz. Örnek:
