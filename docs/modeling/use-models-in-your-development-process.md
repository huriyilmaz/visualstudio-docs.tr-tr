...
description: Visual Studio 'da bir sistem, uygulama veya bileşeni anlamanıza ve değiştirmenize yardımcı olması için bir model kullanabileceğinizi öğrenin.
