...
4. Modellemeye **Ekle Project,** çözümünüzde var olan bir modelleme projesine gidin ve seçin.
...
2. Çözüm klasörlerini kaldırmak için Kod Eşlemesi filtresi ve yalnızca ürün kodunda bağımlılıkları zorlamak için "Varlıkları Test Edin" filtresini uygulamayı göz önünde bulundurabilirsiniz.
