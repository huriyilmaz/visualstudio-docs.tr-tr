...
Metin şablonları, bir dönüştürme işlemi aracılığıyla program kodu veya diğer metin dosyaları oluşturmanıza olanak sağlayan bir Visual Studio özelliğidir. [!INCLUDE[vssdk_current_short](../modeling/includes/vssdk_current_short_md.md)]kullanarak, metin şablonu yönerge işlemcisini veya metin şablonu konağını özelleştirerek varsayılan şablon dönüşüm işlemini genişletebilirsiniz.
