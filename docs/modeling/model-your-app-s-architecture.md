...
description: yazılım sisteminizin veya uygulamanızın genel yapısına ve davranışına ilişkin açıklamanın bir parçası olarak Visual Studio ' de modeller oluşturma hakkında bilgi edinin.
