---
title: SharePoint İş Akışı Çözümleri | Microsoft Docs
...
## <a name="workflows-in-sharepoint"></a>SharePoint'de iş akışları
 ...
 içinde iş SharePoint oluşturabilir ve [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] bunları bir web sitesine SharePoint dağıtabilirsiniz. Bir iş akışı bir iş akışı SharePoint bir kitaplık veya listeyle ilişkilendirildi. Daha sonra otomatik olarak, bir işlem tarafından veya bir kullanıcı tarafından el ile başlatılabilir. İş akışı işlemi hakkında daha fazla bilgi için [bkz. SharePoint kullanarak iş Visual Studio.](/sharepoint/dev/general-development/develop-sharepoint-workflows-using-visual-studio)
...
- *Bileşik etkinlikler diğer* etkinlikleri içerir; Örneğin, bir koşullu etkinlik iki dal içerebilir.
  ...
  Özel etkinlik de oluşturabilirsiniz. Daha fazla bilgi için [bkz. Adım adım: Özel bir site iş akışı etkinliği oluşturma.](../sharepoint/walkthrough-create-a-custom-site-workflow-activity.md)
...
- Görev
  ...
  Bunların arasında [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] ilişkilendirme ve başlatan formlar için öğe şablonları yer almaktadır. İlişki oluşturma formuna *örnek olarak,* iş akışını yükleyerek yöneticinin iş akışıyla ilgili parametreleri (harcama iş akışı için harcama limiti gibi) girmesini sağlayan bir form vardır. Başlatma formuna *örnek olarak,* bir gider iş akışının kullanıcılarının iş akışına harcanan miktarı girmelerini sağlayan bir form vardır. Bu form türleri hakkında daha fazla bilgi için [bkz. SharePoint proje ve proje öğesi şablonları.](../sharepoint/sharepoint-project-and-project-item-templates.md)
