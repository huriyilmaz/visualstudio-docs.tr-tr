...
description: Visual Studio 'da ilişkiler oluşturarak Iş verileri bağlantısı (BDC) modelinizdeki varlıklar arasındaki ilişkileri tanımlayın.
