...
[![2022 IDE'Visual Studio gösteren ekran görüntüsü, önemli özelliklerin ve işlevlerin konumunu belirten ek ifadelerle birlikte.](../media/vs-2022/ide-overview.png)](../media/vs-2022/ide-overview.png#lightbox)

::: moniker-end

Yukarıdaki görüntüde, Visual Studio pencerelerini ve işlevlerini gösteren açık bir projeyle birlikte aşağıdaki özellikler yer aleni bir şekilde görüntüye sahiptir:
...
- Sağ [altta](/visualstudio/version-control/) yer alan Git Değişiklikleri'nde, [Git](https://git-scm.com/) ve diğer sürümler gibi sürüm denetimi teknolojilerini kullanarak iş öğelerini izleyebilir ve [başka](https://docs.github.com/github)GitHub.

## <a name="editions"></a>Sürümler

Visual Studio Mac için Windows kullanılabilir. [Mac için Visual Studio,](/visualstudio/mac/) Windows için Visual Studio özelliklere sahiptir ve platformlar arası ve mobil uygulamalar geliştirmek için iyileştirilmiştir. Bu makale, Windows sürümüne Visual Studio.
...
- Kod Temizleme
   ...
   ![Uygulamanın kod temizleme simgesini ve menüsünü gösteren Visual Studio.](../media/vs-2019/code-cleanup.png)
   ::: moniker-end
...
- Kod Temizleme
   ...
   ![Uygulamanın kod temizleme simgesini ve menüsünü gösteren Visual Studio.](../media/vs-2022/code-cleanup.png)
   ::: moniker-end
...
- [Yeniden Düzenle](../../ide/refactoring-in-visual-studio.md)
   ...
   ::: moniker range="<=vs-2019"
   ![Örneklerde Yeniden Düzenlemeyi gösteren Visual Studio.](../media/refactoring-menu.png)
   ::: moniker-end
   ::: moniker range=">=vs-2022"
   ![Örneklerde Yeniden Düzenlemeyi gösteren Visual Studio.](../media/vs-2022/refactoring-menu.png)
   ::: moniker-end
...
- [Visual Studio arama](../../ide/visual-studio-search.md)
   ...
   ![Visual Studio 2017'de Hızlı Başlat kutusunu gösteren ekran görüntüsü.](../media/quick-launch-nuget.png)
...
1. **Ek bilgi** penceresinde, **.net 6,0** ' in **hedef Framework** açılan menüsünde göründüğünü doğrulayın ve ardından **Oluştur**' u seçin.
   ...
   Visual Studio projeyi oluşturur. Program, Hello, World! Merhaba Dünya yöntemini çağıran basit bir <xref:System.Console.WriteLine?displayProperty=nameWithType> "Merhaba Dünya" **uygulamasıdır.** bir konsol penceresinde.

   Proje dosyaları, IDE'nin Visual Studio tarafında, **Çözüm Gezgini.** Yeni **Çözüm Gezgini** **Program.cs dosyasını** seçin. Uygulamanıza uygun C# kodu merkezi düzenleyici penceresinde açılır ve bu da yerlerin çoğunu alır.
...
1. Kullanılabilir Hızlı Eylemler'i göstermek için ampul [simgesini seçin.](../../ide/quick-actions.md) **'name' adını 'username' olarak yeniden adlandır'ı seçin.**
   ...
   ::: moniker range="vs-2017"
   ![Dosyanın yeniden adlandırma eylemlerini gösteren Visual Studio.](../media/rename-quick-action.png)
   ::: moniker-end
   ::: moniker range="vs-2019"
   ![Dosyanın yeniden adlandırma eylemlerini gösteren Visual Studio.](../media/vs-2019/rename-quick-action.png)
   ::: moniker-end
   ::: moniker range=">=vs-2022"
   ![Dosyanın yeniden adlandırma eylemlerini gösteren Visual Studio.](../media/vs-2022/rename-quick-action.png)
   ::: moniker-end
...
Kod yazarak çalıştırmanız ve hatalara karşı test etmek gerekir. Visual Studio hata ayıklama sistemi, kodda tek tek bir deyimde adım adım ilerler ve değişkenleri ilerlerken inceler. Belirli bir *satırda kodun* yürütülmesini durduran kesme noktaları ayarlayın ve kod çalıştırıken değişken değerinin nasıl değiştiklerini gözlemlersiniz.
...
Hata ayıklayıcıda hata ayıklama hakkında daha fazla Visual Studio bkz. [Hata Ayıklayıcı özellik turu.](../../debugger/debugger-feature-tour.md)
