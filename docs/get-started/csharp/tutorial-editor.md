...
description: Visual Studio kod düzenleyicisine bu 10 dakikalık giriş, Visual Studio C# kodunu yazma, gezinme ve anlama işlemlerini daha kolay hale getiren bazı yolları gösterir.
...
ms.locfileid: "122157923"
---
# <a name="learn-to-use-the-code-editor-with-c"></a>C ile kod düzenleyicisini kullanmayı öğrenin\#

Visual Studio kod düzenleyicisine bu 10 dakikalık bir giriş içinde, Visual Studio C# kodunu yazmayı, gezinmeyi ve anlamayı kolaylaştıran bazı yöntemlere bakmak için bir dosyaya kod ekleyeceğiz.
...
Bu makalede, C# hakkında zaten bilgi sahibi olduğunuz varsayılır. bu durumda, [C# ile çalışmaya başlama ve Visual Studio önce ASP.NET Core](tutorial-aspnet-core.md) gibi bir öğreticiye bakmanız önerilir.
