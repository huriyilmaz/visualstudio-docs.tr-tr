...
Bu makalede, kaynaklarla ilgili bilgi sahibi Visual Basic. Yoksa, ilk olarak Visual Basic ile Kullanmaya başlayın gibi [bir Visual Studio](../../get-started/visual-basic/tutorial-console.md) öneririz.
