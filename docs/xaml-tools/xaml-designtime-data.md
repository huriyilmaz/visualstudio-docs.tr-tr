...
Bu önceki örnekte, önceki örnekte üç TextBlocks ile birlikte bir ListView XAML Tasarımcısı.
...
- .NET Core ve UWP için Windows Presentation Foundation (WPF) hedef alan Windows masaüstü projelerini destekler. Bu özellik önizleme kanalında .NET Framework için [de kullanılabilir.](/visualstudio/releases/2019/release-notes-preview) Etkinleştirmek için, Araçlar Seçenekler **Ortam** Önizleme Özellikleri'ne gidin, Yeni  >  WPF özellikleri'XAML Tasarımcısı'.NET Framework'i  >    >  yeniden başlatın ve Visual Studio. 
