...
description: Öğeleri için stilleri ve şablonları depolayabilmeniz ve yeniden kullanabilmeniz için XAML Tasarımcısı bir kaynağı oluşturma ve uygulama hakkında bilgi edinin.
