...
Ayrıca, tüm seçimi uygulamak için kod seçip **Ctrl**+**ENTER** tuşlarına basabilirsiniz. Alternatif olarak, seçime sağ tıklayıp **etkileşimli olarak çalıştır**' ı seçin.
