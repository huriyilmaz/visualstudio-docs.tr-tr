...
C# **veya Windows formlar için** yeni bir Visual Basic. Projeye **ReadingXML adını girin.**
...
1. Bu **Çözüm Gezgini** **Form1'i** seçin ve ardından **Form1'Görünüm Tasarımcısı** seçin.
