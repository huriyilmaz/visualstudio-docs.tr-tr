...
description: Visual Studio içindeki veri kaynakları penceresinden WPF tasarımcısı veya Windows Forms tasarımcısı üzerine sürüklediğinizde, denetimin nasıl ayarlanacağını öğrenin.
