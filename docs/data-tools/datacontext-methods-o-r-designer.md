...
DataContext yöntemleri, veritabanındaki saklı yordamlar ve işlevlerle eşlenen yöntemlerdir. **O/R tasarımcısının** **Yöntemler** bölmesinde DataContext yöntemleri oluşturabilir ve ekleyebilirsiniz. <xref:System.Data.Linq.DataContext> yöntemlerinin iki farklı türü vardır; bir veya daha fazla sonuç kümesi döndürenler ve olmayanlar:
