...
@No__t-0 sınıfından türetilmiş bir özniteliğin özelliği için oluşturulan bir uyarıyı gizleyebilirsiniz. Öznitelikler, diziler döndüren özellikler içerebilir, ancak koleksiyonlar döndüren Özellikler içeremez.
...
Aşağıdaki örnek, özelliği bir @no__t döndürecek şekilde değiştirerek ihlalin düzeltir:
...
- [CA1024: Uygun yerlerde özellikleri kullanın @ no__t-0