...
@No__t_0 sınıfından türetilmiş bir özniteliğin özelliği için oluşturulan bir uyarıyı gizleyebilirsiniz. Öznitelikler, diziler döndüren özellikler içerebilir, ancak koleksiyonlar döndüren Özellikler içeremez.
...
Aşağıdaki örnek, özelliği bir <xref:System.Collections.ObjectModel.ReadOnlyCollection%601?displayProperty=fullName> döndürecek şekilde değiştirerek ihlalin düzeltir:
