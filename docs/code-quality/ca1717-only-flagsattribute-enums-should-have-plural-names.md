...
Adlandırma kuralları, bir numaralandırma için çoğul adının aynı anda birden fazla sabit değer olarak belirtilebileceğini gösterir. @No__t-0, derleyicilerin sabit listesi üzerinde bit düzeyinde işlemler sağlayan bir bit alanı olarak değerlendirildiğini belirtir.
