...
description: İki ortak veya korumalı üyenin, dönüş türü dışında aynı imzaları vardır.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Aşağıdaki örnekte, Microsoft ara dili (MSIL), bu kuralı ihlal eden bir türü gösterir. Bu kuralın C# veya Visual Basic kullanılarak ihlal edilemez olduğunu unutmayın.
