...
| [CA1504: Yanlış alan adlarını gözden geçirin](../code-quality/ca1504.md) | Bir örnek alanının adı "s_" ile başlar veya statik ([!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]ile paylaşılan) alanının adı "m_" ile başlar. |
