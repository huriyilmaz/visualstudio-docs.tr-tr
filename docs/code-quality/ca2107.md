...
<xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName> güvenlik eylemi yalnızca .NET güvenlik hakkında gelişmiş bir bilgiye sahip olanlar tarafından kullanılmalıdır. Bu güvenlik eylemlerini kullanan kod güvenlik incelemesi altından geçmelidir.
