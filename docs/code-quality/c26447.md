...
- Kural yalnızca işlev çağrılarına odaklanır. **Constexpr** olmayan ve özel durumlar oluşturabilecek hedefleri işaret edebilir; diğer bir deyişle, **noexcept**, **__declspec (nothrow)** , **throw ()** kullanılarak doğrudan oluşturmama olarak işaretlenmemiştir.
