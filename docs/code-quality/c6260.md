...
Uyarı C6260: sizeof * sizeof neredeyse her zaman hatalı, bir karakter sayısı veya bayt sayısı kullanmayı mı amaçladınız?
 ...
 @No__t_0 işleciyle ilişkili, sezgisel olmayan bazı davranışlar vardır. Örneğin, C 'de, bir karakter integral türünde olduğundan, `sizeof ('\0') == 4,`. ' C++De, bir karakter sabit değerinin türü `char` ' dir, bu nedenle `sizeof ('\0') == 1`. Ancak, hem C hem C++de aşağıdaki doğru geçerlidir:
