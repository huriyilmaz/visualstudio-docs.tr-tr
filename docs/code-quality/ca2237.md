...
Ortak dil çalışma zamanı tarafından seri hale getirilebilir olarak tanınmak için, tür <xref:System.Runtime.Serialization.ISerializable> arabiriminin uygulanması aracılığıyla özel bir serileştirme yordamı kullanıyor olsa da, türlerin <xref:System.SerializableAttribute> özniteliğiyle işaretlenmesi gerekir.

## <a name="how-to-fix-violations"></a>İhlalleri çözme
Bu kuralın ihlalini onarmak için <xref:System.SerializableAttribute> özniteliğini türüne uygulayın.
