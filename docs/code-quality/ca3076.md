...
- @No__t-0 bağımsız değişkenini null veya bir <xref:System.Xml.XmlSecureResolver> örneğiyle değiştirin.
...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>İhlalin @ no__t-0document işlevi ve betik yürütme devre dışı değil
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Çözüm @ no__t-0belge işlevini ve betik yürütmeyi devre dışı bırak
