...
- **NuGet paketi olarak yükleme**: Alternatif olarak, `Microsoft.CodeAnalysis.NetAnalyzers` Visual Studio 2019 ' de [NuGet paketini](https://www.nuget.org/packages/Microsoft.CodeAnalysis.NetAnalyzers) yükleyerek bu Çözümleyicileri yükleyebilirsiniz. Visual Studio 2017 kullanıyorsanız, `2.9.x` `Microsoft.CodeAnalysis.FxCopAnalyzers` [NuGet paketinin](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers/)en son sürümünü yükleyebilirsiniz.
