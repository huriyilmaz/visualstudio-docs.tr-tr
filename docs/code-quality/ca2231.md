...
Değer türü <xref:System.Object.Equals%2A?displayProperty=fullName> ' y i geçersiz kılar, ancak eşitlik işlecini uygulamaz.

Bu kural varsayılan olarak yalnızca dışarıdan görünür türlere bakar, ancak bu [yapılandırılabilir](#configurability).

## <a name="rule-description"></a>Kural açıklaması

Çoğu programlama dilinde, değer türleri için eşitlik işlecinin (= =) varsayılan bir uygulamasý yoktur. Programlama diliniz operatör aşırı yüklerini destekliyorsa, eşitlik işlecini uygulamayı düşünmelisiniz. Davranışı <xref:System.Object.Equals%2A> ile aynı olmalıdır.
