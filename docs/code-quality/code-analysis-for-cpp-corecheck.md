...
[C26448 USE_GSL_FINALLY](c26448.md) Son eylem amaçlanıyorsa `gsl::finally` kullanmayı düşünün. Bkz: [C++ temel yönergeleri: GSL.util: yardımcı programlar](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
