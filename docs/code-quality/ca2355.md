---
title: 'CA2355: Serisi kaldırılan nesne grafiğinde güvenli olmayan veri kümesi veya DataTable'
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "86393504"
---
# <a name="ca2355-unsafe-dataset-or-datatable-in-deserialized-object-graph"></a>CA2355: Serisi kaldırılan nesne grafiğinde güvenli olmayan veri kümesi veya DataTable
