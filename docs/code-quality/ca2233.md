...
Aşağıdaki örnekteki bir yöntem, bu kuralı ihlal eden bir tamsayıyı yönetir. [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)], bunun tetiklenmesi için tamsayı taşmasını **Kaldır** seçeneğinin devre dışı olmasını gerektirir.
...
İşaretli bloklar [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] ' da desteklenmez.
