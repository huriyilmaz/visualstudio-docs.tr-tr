...
ms.date: 09/06/2018
description: Visual Studio 'da eski FxCop ve FxCop çözümleyicileri arasındaki farkı anlayın. Bu Çözümleyicileri nasıl kullanacağınızı öğrenmek için bkz. sorulara yanıtlar.
