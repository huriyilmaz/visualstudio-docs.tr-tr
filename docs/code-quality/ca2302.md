...
- Seri durumdan çıkarılan türleri kısıtla. Özel bir uygulama uygulayın <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType> . İle seri durumdan kaldırmadan önce <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> , <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> özelliği özel bir örneğine ayarlayın <xref:System.Runtime.Serialization.SerializationBinder> . Geçersiz kılınan <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> yöntemde, tür beklenmiyorsa, serisini durdurmak için bir özel durum oluşturur.
  - Tüm kod yollarının özellik kümesine sahip olduğundan emin olun <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> .
