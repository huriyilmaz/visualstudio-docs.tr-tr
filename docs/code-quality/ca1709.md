...
Kural gereği, parametre adları ortası büyük harfleri, ad alanı, tür ve üye adları, Pascal büyük harfleri kullanır. Bir Camel adı, ilk harf küçük ve ad içindeki kalan sözcüklerin ilk harfi büyük olur. Camel-cased adlarına örnek olarak `packetSniffer`, `ioFile`ve `fatalErrorCode`verilebilir. Bir Pascal-Kased adında, ilk harf büyük harfli ve ad içindeki kalan sözcüklerin ilk harfi büyük harfle yazılır. `PacketSniffer`, `IOFile`ve `FatalErrorCode`, Pascal özellikli adlara örnek olarak verilebilir.
