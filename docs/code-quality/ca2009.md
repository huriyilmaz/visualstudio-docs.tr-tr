---
title: 'CA2009: bir ımmutablecollection değerinde ToImmutableCollection çağırmayın'
ms.date: 04/29/2020
ms.topic: reference
f1_keywords:
- CA2009
...
ms.locfileid: "82587707"
---
# <a name="ca2009-do-not-call-toimmutablecollection-on-an-immutablecollection-value"></a>CA2009: bir ımmutablecollection değerinde ToImmutableCollection çağırmayın

|||
|-|-|
|TypeName|Donotcalltoımmutablecollectiononanımmutablecollectionvalueanalyzer|
|CheckId|CA2009|
...
`ToImmutable`Yöntem, ad alanından <xref:System.Collections.Immutable> sabit bir koleksiyonda gereksiz şekilde çağrıldı.
...
Bu türler, var olan <xref:System.Collections.Generic.IEnumerable%601> bir koleksiyondan yeni bir sabit koleksiyon oluşturan genişletme yöntemlerini tanımlar.
...
> [!NOTE]
> Rule CA2009, eski çözümlemede kullanılamıyor. İlk olarak [FxCop çözümleyicileri](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers) sürüm 2.9.6 ' de tanıtılmıştı.

## <a name="how-to-fix-violations"></a>İhlalleri çözme

İhlalleri onarmak için, sabit bir koleksiyondaki `ToImmutable` gereksiz çağrıyı kaldırın. Örneğin, aşağıdaki iki kod parçacığı kural ihlalini ve nasıl düzeltileceğini gösterir:
