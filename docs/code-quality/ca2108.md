...
Aşağıdaki örnek, bu kuralı ihlal eden bir değer türü içeren bir kitaplığı göstermektedir. @No__t-0 türü, değer türünün bir örneğini geçiren bir çağıranın örnek oluşturma veya bu örneğe erişme iznine sahip olduğunu varsayar.
