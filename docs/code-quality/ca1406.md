...
description: Özellikle bileşen nesne modeli (COM) tarafından görünür olarak işaretlenen bir tür, System. Int64 bağımsız değişkenini alan bir üye bildirir.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
