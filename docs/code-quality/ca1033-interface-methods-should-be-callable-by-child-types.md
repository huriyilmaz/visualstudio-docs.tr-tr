...
Dışarıdan görünür `Close()` veya `System.IDisposable.Dispose(Boolean)` yöntemi sağlandığında, bu kural <xref:System.IDisposable.Dispose%2A?displayProperty=fullName> ' ın açık bir uygulamasına yönelik bir ihlal raporlamaz.
