...
- <xref:System.Runtime.Serialization.OnDeserializedAttribute?displayProperty=fullName>
  ...
  Serileştirme olayı işleyicileri türünde tek bir parametre <xref:System.Runtime.Serialization.StreamingContext?displayProperty=fullName> alır, dönüş `void` ve görünürlük `private` sağlar.

## <a name="how-to-fix-violations"></a>İhlalleri düzeltme
Bu kuralın ihlallerini düzeltmek için serileştirme olay işleyicisi imzasını, dönüş türünü veya görünürlüğünü düzeltin.
