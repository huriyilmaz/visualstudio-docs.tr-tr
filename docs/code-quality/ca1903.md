...
Projenin hedef çerçevesini değiştirmek için bkz. [nasıl yapılır: .NET sürümünü hedefleme](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
