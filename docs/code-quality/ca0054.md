---
title: 'CA0054: Özel kural derlemesi geçersiz XML kaynaklarına sahip.'
description: Özel bir kural derlemesinde kurallarını açıklayan geçersiz XML kaynakları varsa bu durum oluşur.
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
...
ms.locfileid: "122122481"
---
# <a name="ca0054"></a>CA0054
Özel kural derlemesi geçersiz XML kaynaklarına sahip.

Özel bir kural derlemesinde kurallarını açıklayan geçersiz XML kaynakları varsa bu durum oluşur. Doğru biçim aşağıdaki gibidir:
