...
Bileşen nesne modeli (COM) görünür değer türü, <xref:System.Runtime.InteropServices.LayoutKind.Auto?displayProperty=fullName>olarak ayarlanan <xref:System.Runtime.InteropServices.StructLayoutAttribute?displayProperty=fullName> özniteliği ile işaretlenir.

## <a name="rule-description"></a>Kural açıklaması

<xref:System.Runtime.InteropServices.LayoutKind> Düzen türleri ortak dil çalışma zamanı tarafından yönetilir. Bu türlerin düzeni, belirli bir düzeni bekleyen COM istemcilerini kesen .NET sürümleri arasında değişebilir. <xref:System.Runtime.InteropServices.StructLayoutAttribute> özniteliği belirtilmezse, C#, Visual Basic ve C++ derleyiciler değer türleri için [LayoutKind. Auto](<xref:System.Runtime.InteropServices.LayoutKind.Auto>) belirtir.
