...
ms.locfileid: "72009088"
---
# <a name="c6250"></a>C6250
Uyarı C6250: MEM_RELEASE bayrağı olmadan \<function > sanallaştırmaya çağırmak, belleği serbest bırakabilir, ancak adres tanımlayıcılarını (VADs) içeremez. Adres alanı sızıntılarına ilişkin sonuçlar
