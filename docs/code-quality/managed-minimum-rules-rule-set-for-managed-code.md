...
ms.date: 11/04/2016
description: güvenlik, sağlamlık ve diğer kritik sorunlara odaklanan Visual Studio, yönetilen Minimum kurallar kural kümesi hakkında bilgi edinin. Bkz. kural açıklamaları.
...
|[CA2231](/dotnet/fundamentals/code-analysis/quality-rules/ca2231)|Geçersiz kılma için aşırı yükleme işleci eşittir `ValueType.Equals`|
