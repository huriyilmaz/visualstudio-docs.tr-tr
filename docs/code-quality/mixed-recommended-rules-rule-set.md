...
ms.locfileid: "81649335"
---
# <a name="mixed-recommended-rules-rule-set"></a>Karışık Önerilen Kurallar kural kümesi

Microsoft Karışık Önerilen Kurallar, Olası güvenlik açıkları, uygulama çökmeleri ve diğer önemli mantık ve tasarım hataları da dahil olmak üzere Ortak Dil Çalışma Süresini destekleyen C++ projelerinizdeki en yaygın ve kritik sorunlara odaklanır. Bu kural kümesi, [Karışık Minimum Kurallar](mixed-minimum-rules-rule-set.md) kuralı kümesindeki tüm kuralları içerir.

Ortak Dil Çalışma Süresini destekleyen C++ projeleriniz için oluşturduğunuz özel kural kümesine bu kural kümesini ekleyin.
...
|[CA2111 1](../code-quality/ca2111.md)|İşaretçiler görünür olmamalıdır|
...
|[CA2137 CA2137](../code-quality/ca2137.md)|Saydam metotlar yalnızca doğrulanabilir IL içermelidir|
...
|[CA2141](../code-quality/ca2141.md)|Saydam yöntemler LinkDemands'ı karşılamamalıdır|
