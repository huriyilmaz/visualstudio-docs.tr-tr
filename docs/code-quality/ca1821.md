...
Boş sonlandırıcıyı kaldırın. Hata ayıklama için bir Sonlandırıcı gerekliyse, tüm sonlandırıcıyı `#if DEBUG / #endif` yönergeleriyle çevreedin.
...
Aşağıdaki örnek, kaldırılması gereken boş bir Sonlandırıcı, `#if DEBUG / #endif` yönergeleri içine alınması gereken sonlandırıcının ve `#if DEBUG / #endif` yönergelerini doğru bir şekilde kullanan sonlandırıcının gösterildiği gösterilmektedir.
