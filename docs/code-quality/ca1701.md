...
description: Kaynak dizesi, doğru şekilde görünmeyen bir bileşik sözcük içerir.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
...
Ayrıca, yazım denetleyicisi için özel bir sözlüğe bileşik sözcükler ekleyebilirsiniz. Özel Sözlükteki sözcükler ihlallere neden olmaz. daha fazla bilgi için bkz. [nasıl yapılır: Code Analysis sözlüğünü özelleştirme](../code-quality/how-to-customize-the-code-analysis-dictionary.md).
