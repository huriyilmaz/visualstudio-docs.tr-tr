---
title: 'CA1832: bir dizinin ReadOnlySpan veya ReadOnlyMemory bölümünü almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın'
ms.date: 06/04/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "85290558"
---
# <a name="ca1832-use-asspan-or-asmemory-instead-of-range-based-indexers-for-getting-readonlyspan-or-readonlymemory-portion-of-an-array"></a>CA1832: bir dizinin ReadOnlySpan veya ReadOnlyMemory bölümünü almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın
...
- [CA1833: bir dizinin yayılımını veya bellek kısmını almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın](ca1833.md)
