---
title: 'CA1833: bir dizinin yayılımını veya bellek kısmını almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın'
ms.date: 06/04/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "85290546"
---
# <a name="ca1833-use-asspan-or-asmemory-instead-of-range-based-indexers-for-getting-span-or-memory-portion-of-an-array"></a>CA1833: bir dizinin yayılımını veya bellek kısmını almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın
...
- [CA1832: bir dizinin ReadOnlySpan veya ReadOnlyMemory bölümünü almak için Aralık tabanlı dizin oluşturucular yerine AsSpan veya AsMemory kullanın](ca1832.md)
