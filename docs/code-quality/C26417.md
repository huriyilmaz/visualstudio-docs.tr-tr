...
**C++ Temel yönergeler**: R. 35: Bir işlevin paylaşılan işaretçiyle yeniden mühürde olabileceğini ifade etmek için bir shared_ptr @ no__t-0pencere öğesi > & parametresini al
