...
@No__t-0 özniteliğinin serileştirme üzerinde hiçbir etkisi yoktur; özniteliği ile işaretlenmiş bir alan serileştirilir. Ancak, alanı seri hale getirme sırasında yok sayılır ve kendi türüyle ilişkili varsayılan değeri korur. Seri hale getirme işlemi sırasında alanı ayarlamak için de serileştirme olay işleyicileri bildirilmelidir.
