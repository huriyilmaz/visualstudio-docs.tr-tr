...
Bir tür, <xref:System.Runtime.Serialization.OptionalFieldAttribute?displayProperty=fullName> özniteliğiyle işaretlenmiş bir alana sahiptir ve tür, seri hale getirme olay işleme yöntemleri sağlamıyor.

## <a name="rule-description"></a>Kural açıklaması
<xref:System.Runtime.Serialization.OptionalFieldAttribute> özniteliğinin serileştirme üzerinde hiçbir etkisi yoktur; özniteliği ile işaretlenmiş bir alan serileştirilir. Ancak, alanı seri hale getirme sırasında yok sayılır ve kendi türüyle ilişkili varsayılan değeri korur. Seri hale getirme işlemi sırasında alanı ayarlamak için de serileştirme olay işleyicileri bildirilmelidir.
