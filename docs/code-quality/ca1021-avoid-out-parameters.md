...
@No__t-2 gibi **TRY @ no__t-1Bir >** modelini uygulayan yöntemler bu ihlalin oluşturmaz. Aşağıdaki örnek, <xref:System.Int32.TryParse%2A?displayProperty=fullName> yöntemini uygulayan bir yapıyı (değer türü) gösterir.
