...
Aşağıdaki örnek, güvenli olmayan alanları olan bir kitaplık türü (`SecuredTypeWithFields`), kitaplık türü örnekleri oluşturabileceğiniz bir tür (`Distributor`) ve hatalı bir şekilde örnekleri, türü güvenlik altına alan izne sahip olmasa bile bir örnek alanlarını okuyabilen uygulama kodu ' nu () oluşur.
