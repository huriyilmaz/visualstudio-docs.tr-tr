...
Bu kural, girişten belirtilen türlerin serisini kaldırmak için yapılandırılmış olabilecek [Newtonsoft. JSON. JsonSerializerSettings](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) örneklerini bulur, ancak bir [Newtonsoft. JSON. Serialization. ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm)ile serisi kaldırılan türleri kısıtlamak üzere yapılandırılamayabilir. Girişten tamamen belirtilen türlerin serisini kaldırma iznini kaldırmak istiyorsanız, [CA2327](ca2327.md), CA2328, [CA2329](ca2329.md)ve [CA2330](ca2330.md)kurallarını devre dışı bırakın ve bunun yerine kural [CA2326](ca2326.md) etkinleştirin.
