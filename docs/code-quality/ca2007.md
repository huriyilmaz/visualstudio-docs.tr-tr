...
Tüketicinin bir grafik kullanıcı arabirimi (GUI) uygulaması olmadığını veya tüketicinin bir öğesine sahip olmadığını biliyorsanız, bu uyarıyı gizleyebilirsiniz <xref:System.Threading.SynchronizationContext> .
