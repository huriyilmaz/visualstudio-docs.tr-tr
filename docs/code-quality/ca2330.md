...
Bu kural, [Newtonsoft.Json.JsonSerializer](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) örneği için aşağıdaki koşulların her ikisi de doğru olduğunda ateşlenir:
