---
title: 'CA3012: Regex ekleme güvenlik açıkları için kodu gözden geçirme'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809385"
---
# <a name="ca3012-review-code-for-regex-injection-vulnerabilities"></a>CA3012: Regex ekleme güvenlik açıkları için kodu gözden geçirme
...
- <xref:System.Text.RegularExpressions.Regex.Escape%2A?displayProperty=fullName> veya başka bir yöntemi çağırarak Kullanıcı girişinden özel karakterleri kaçış.
