---
title: 'CA5360: serisini kaldırma bölümünde tehlikeli yöntemleri çağırmayın'
...
ms.locfileid: "85290523"
---
# <a name="ca5360-do-not-call-dangerous-methods-in-deserialization"></a>CA5360: serisini kaldırma bölümünde tehlikeli yöntemleri çağırmayın
