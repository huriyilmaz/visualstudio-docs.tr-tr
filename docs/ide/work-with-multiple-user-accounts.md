...
bunu eylemde görmek için yeni bir **ASP.NET Core Web uygulaması** projesi oluşturun. **Ek bilgiler** sayfasında, **hedef çerçeve** açılır listesinden **.NET Core 3,1 (uzun süreli destek)** öğesini seçin ve ardından **kimlik doğrulama türü** açılan listesinden **Microsoft Identity platform** ' u seçin.

::: moniker-end

::: moniker range=">=vs-2022"

bunu eylemde görmek için yeni bir **ASP.NET Core Web uygulaması** projesi oluşturun. **Ek bilgiler** sayfasında, **hedef çerçeve** açılır listesinden **.NET Core 6 (uzun süreli destek)** öğesini seçin ve ardından **kimlik doğrulama türü** açılan listesinden **Microsoft Identity platform** ' u seçin.
