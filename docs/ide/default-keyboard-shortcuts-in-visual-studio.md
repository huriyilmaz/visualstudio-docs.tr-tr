...
## <a name="adonet-entity-data-model-designer"></a>{1&gt;ADO.NET Varlık Veri Modeli Tasarımcısı&lt;1}
...
## <a name="html-editor"></a>{1&gt;HTML Düzenleyicisi&lt;1}
...
## <a name="microsoft-sql-server-data-tools-t-sql-pdw-editor"></a>{1&gt;Microsoft SQL Server Veri Araçları, T-SQL PDW Düzenleyicisi&lt;1}
...
## <a name="page-inspector"></a>{1&gt;Sayfa Denetçisi&lt;1}
...
## <a name="vc-string-editor"></a>{1&gt;VC Dize Düzenleyicisi&lt;1}
...
## <a name="work-item-results-view"></a>{1&gt;Çalışma Öğesi Sonuçlar Görünümü&lt;1}
