...
|Komut|Klavye kısayolu|
|-------------| - |
|OtherContextMenus.MicrosoftDataEntityDesignContext.AddNewDiagram|**Ekleyin**|
...
|TeamFoundationContextMenus.Commands.GoToMyWork|**CTRL + 0** (sıfır), **CTRL + ı**<br /><br /> veya<br /><br /> **CTRL + 0, ı**|
...
|Komutlar|Klavye kısayolları|
|--------------| - |
|Window.ActivateDocumentWindow|**Larına**|
...
|OtherContextMenus.MicrosoftDataEntityDesignContext.MoveProperties.ToBottom|**Alt + son**|
...
|Komutlar|Klavye kısayolları|
|--------------| - |
|ClassDiagram.Collapse|**Numaraları**|
...
|Komutlar|Klavye kısayolları|
|--------------| - |
|OtherContextMenus.ColumnContext.InsertColumn|**Ekleyin**|
...
|Komutlar|Klavye kısayolları|
|--------------| - |
|ArchitectureContextMenus.DirectedGraphContextMenu.Advanced.Add.AddNode|**Ekleyin**|
...
|Komutlar|Klavye kısayolları|
|--------------| - |
|SQL.QueryResultsNewRow|**Alt + son**|
...
| Edit.CollapseAllOutlining | **CTRL + a, CTRL + A** |
| Edit.CollapseCurrentRegion | **Ctrl + k, CTRL + S** |
| Edit.CollapseTag | **Ctrl + k, CTRL + T** |
...
| Edit.ExpandAllOutlining | **CTRL + a, CTRL + X** |
...
| Edit.OvertypeMode | **Ekleyin** |
| Edit.PageDown | **PgDn** |
| Edit.PageDownExtend | **SHIFT + PgDn** |
| Edit.PageUp | **PgUp** |
| Edit.PageUpExtend | **SHIFT + PgUp** |
| Edit.ParameterInfo | **CTRL + SHIFT + boşluk çubuğu** |
...
| Edit.ToggleOutliningExpansion | **CTRL + a, CTRL + ı** |
...
|Image.MagnificationTool|**CTRL + a**|
|Image.Magnify|**CTRL + SHIFT + d**|
|Image.NewImageType|**Ekleyin**|
...
|Edit.ParameterInfo|**CTRL + K, P**<br /><br /> veya<br /><br /> **CTRL + K, CTRL + P**<br /><br /> veya<br /><br /> **CTRL + SHIFT + boşluk çubuğu**|
