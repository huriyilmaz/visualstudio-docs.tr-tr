...
`Package` ve `ID` özniteliklerini kullanmadığınız durumlar için metin değeri gereklidir.
...
Aşağıdaki örnek, bir görsel C# uygulama için bir proje şablonu meta verilerini gösterir:
