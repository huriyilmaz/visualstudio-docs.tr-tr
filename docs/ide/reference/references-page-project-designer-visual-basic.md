...
- <xref:System.Math?displayProperty=fullName>gibi sınıflar veya ad alanları.

- `VB=Microsoft.VisualBasic`gibi diğer ad almalar.

- `<xmlns:xsl="http://www.w3.org/1999/XSL/Transform">`gibi XML ad alanları.
