...
C++ biçimlendirme EditorConfig ayarları ön ekine sahiptir `_cpp__` . Aşağıda, EditorConfig dosyanızın nasıl görünebileceğini bir örnek verilmiştir:
