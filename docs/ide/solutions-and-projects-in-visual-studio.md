---
title: Visual Studio çözüm projeleri nelerdir &amp; ?
...
ms.locfileid: "112306403"
---
# <a name="what-are-solutions-and-projects-in-visual-studio"></a>Visual Studio 'da çözümler ve projeler nelerdir?

Bu makalede, Visual Studio 'da bir *projeyi* ve *çözümü* öğreneceksiniz. Ayrıca Çözüm Gezgini araç penceresini ve yeni bir proje oluşturmayı kısaca ele alır.
...
![Visual Studio 'da iki projeyle Çözüm Gezgini ekran görüntüsü.](../ide/media/solution-explorer.png)
