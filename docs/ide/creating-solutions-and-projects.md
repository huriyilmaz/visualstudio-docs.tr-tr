---
title: Visual Studio projelerini & oluşturma & çözümleri kullanma
...
ms.locfileid: "112500909"
---
# <a name="create-work-with-and-delete-visual-studio-projects-and-solutions"></a>Visual Studio projelerini ve çözümlerini oluşturun, bunlarla çalışın ve silin

Bu makalede, uygulamalarınızı derlemek için gereken yapıtları depolamak üzere Visual Studio projelerini sıfırdan oluşturma ve kullanma hakkında bilgi edineceksiniz.  Visual Studio 'daki projelerle ilgili bilgi sahibi değilseniz, bu [projelere ve çözümlere](solutions-and-projects-in-visual-studio.md)genel bakış konusuna bakın.  Bir şablondan hızlıca bir proje oluşturmayı öğrenmek için, bkz. [Şablondan proje oluşturma](create-new-project.md).
