...
description: Windows adım Visual Studio Visual Basic Formlar uygulaması oluşturma hakkında bilgi edinebilirsiniz.
ms.date: 09/27/2019
ms.topic: tutorial
ms.devlang: vb
author: j-martens
...
ms.locfileid: "122056387"
---
# <a name="create-a-windows-forms-app-in-visual-studio-with-visual-basic"></a>Windows ile Visual Studio Forms uygulaması Visual Basic
...
Henüz Visual Studio [Visual Studio 2022 Preview](https://visualstudio.microsoft.com/vs/preview/vs2022) indirmeleri sayfasına gidip ücretsiz olarak yükleyin.
...
1. Yeni **proje oluştur penceresinde,** yeni proje için **Windows Forms Uygulaması (.NET Framework)** şablonunu Visual Basic.
   ...
   (Tercih ederseniz, istediğiniz şablona hızla gitmek için aramanızı geliştirebilirsiniz. Örneğin, arama kutusuna *Windows Forms Uygulaması yazın* veya yazın. Ardından Dil **Visual Basic'yi** seçin ve ardından Platform **listesinden Windows'yi** seçin.)  

   ![Windows Forms Uygulaması için Visual Basic şablonunu seçin (.NET Framework)](../get-started/visual-basic/media/vs-2019/vb-create-new-project-search-winforms-filtered.png)
...
1. Yeni **projenizi yapılandır penceresine** Yeni projenizin adı kutusuna *HelloWorld* **yazın Project girin.** Ardından **Oluştur'a seçin.**
...
Uygulama proje şablon Visual Basic ve dosyanıza bir ad verdikten sonra Visual Studio form açar. Form, Windows arabirimidir. Forma denetimler ekleyerek bir "Merhaba Dünya" uygulaması oluşturacak ve ardından uygulamayı çalıştıracak.
