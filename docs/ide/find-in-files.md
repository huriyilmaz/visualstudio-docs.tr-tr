...
- **Dış öğe Ekle** -bu seçeneği, "Windows. h" gibi, çözümün parçası olmayan, örneğin "Windows. h" gibi harici öğeleri dahil etmek için kullanın.
- **Çeşitli dosyaları dahil et** -bu seçeneği, açtığınız ve çözümün parçası olmayan dosyalar gibi çeşitli dosyaları dahil etmek için kullanın.

## <a name="file-types"></a>Dosya türleri

**Dosya türleri** seçeneği, dizinde **Bakılacak** dosya türlerini gösterir. Belirli türlerin dosyalarını bulacak önceden yapılandırılmış bir arama dizesi girmek için listedeki herhangi bir öğeyi seçin. Ayrıca dosyaları dışarıda bırakabilirsiniz. Bunu yapmak için, aramadan dışlamak üzere herhangi bir yolu veya dosya türünü "!" karakteriyle önek olarak ekleyin.
