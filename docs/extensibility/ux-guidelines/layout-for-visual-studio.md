...
ms.locfileid: "72747176"
---
# <a name="layout-for-visual-studio"></a>Visual Studio için Düzen
...
## <a name="BKMK_UtilityDialogLayout"></a>Yardımcı program iletişim kutusu düzeni
...
- **Tamam**/**iptal** edildiğinde iç düğmelerden oluşan dikey bir hizalama (sütun) kullanın ve sağ alt köşede yatay olarak yönlendirilmelidir.

- **Tamam**/**iptal** olduğunda iç düğmelerin yatay hizalamasını (satır) kullanın ve sağ üst köşedeki dikey olarak yönlendirilmelidir. Bu durum daha az yaygındır.

- İç düğme boyutu, mümkün olduğunda **tamam**/**iptal** düğmeleri boyutunu eşleştirerek, 75x23 piksellik standart düğme boyutunu hedeflemelidir. Düğme etiketi, düğmeyi standart düğme boyutunu aşarsa, bu küme içindeki diğer düğmelerin bu geniş boyutla hizalanması gerekir.
...
## <a name="BKMK_ThemedDialogLayout"></a>Temalı iletişim kutusu düzeni
...
7. Kayıt düğmeleri ( **tamam**/**iptal**gibi) sağ alt köşedeki SIT.
