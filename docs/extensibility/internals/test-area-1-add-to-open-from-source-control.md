...
- İçin [!INCLUDE[vsvss](../../extensibility/includes/vsvss_md.md)] , kaynak denetiminden Aç: **Dosya**, **Aç**, **Proje** / **çözümü**; konuma bakın [!INCLUDE[vsvss](../../extensibility/includes/vsvss_md.md)] .
...
- İçin [!INCLUDE[vsvss](../../extensibility/includes/vsvss_md.md)] , kaynak denetiminden Ekle ' de **Dosya**, **Ekle**, **Varolan proje**' de bulunabilir; [!INCLUDE[vsvss](../../extensibility/includes/vsvss_md.md)] konuma bakın.
