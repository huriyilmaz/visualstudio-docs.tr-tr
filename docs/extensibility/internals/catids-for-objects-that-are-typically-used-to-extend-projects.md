...
description: Visual Basic, Visual C# ve Visual C++ projeleri için Project ve ProjectItem Otomasyon nesnelerini genişletmek için kullanılan nesneler için Catitıd 'leri öğrenin.
