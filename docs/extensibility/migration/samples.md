...
description: Visual Studio 2022 ile çalışmak üzere Visual Studio uzantısının nasıl güncelleştireceğinizi öğrenmek için bir örneği izleyin.
ms.date: 06/08/2021
ms.topic: sample
