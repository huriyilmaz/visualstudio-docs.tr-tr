---
title: Visual Studio uzantıları 'nı güncelleştirmek için ımageiyileştirici örneği
description: Visual Studio uzantısı 'nı Visual Studio 2022 Preview ile çalışacak şekilde güncelleştirmeyi öğrenmek için bir örneği izleyin.
ms.date: 06/08/2021
ms.topic: sample
...
ms.locfileid: "112308841"
---
# <a name="imageoptimizer---update-a-visual-studio-extension-step-by-step"></a>Imageiyileştirici-Visual Studio uzantısı adımını adım adım güncelleştirme
...
Bu kılavuzun sonunda da [ek örneklere](https://github.com/microsoft/VSExtensibility/wiki/Samples#other-samples) ihtiyacımız var.
...
Görüntü Iyileştirici, bazı eski özel 14. * ve 15. * paketlerine başvurdu, bunun yerine tüm gerekli referanslarımızı birleştiren [ `Microsoft.VisualStudio.Sdk` NuGet paketini](https://www.nuget.org/packages/microsoft.visualstudio.sdk) yükleyeceğiz.
...
Visual Studio 2022 ' nin desteklenmesi, Visual Studio 2019 ve Visual Studio 2022 VSıX projeleri arasında paylaşılacak, uzantının kaynak kodunu içerecek yeni bir paylaşılan proje eklenmesini gerektirir.
...
1. Visual Studio 2019 VSıX projenizden bağlantılı dosyaları ekleyin ve "derleme eylemi" ve "VSıX içinde Içer" özelliklerinin eşleşip eşleştiğini doğrulayın. Dosyanızın üzerine da kopyalayın `source.extension.vsixmanifest` , daha sonra Visual Studio 2022 ' i destekleyecek şekilde değişiklik yapacağız.
...
1. Denenen bir derleme, için bir başvuru eksik olduğunu gösterir `System.Windows.Forms` . Yalnızca Visual Studio 2022 projemizi ekleyin ve yeniden derleyin.
...
1. `Microsoft.VisualStudio.SDK` `Microsoft.VSSDK.BuildTools` Visual Studio 2022 sürümlerine yükseltme ve paket başvuruları.
...
1. `source.extension.vsixmanifest`Dosyanızı Visual Studio 2022 hedeflemesini yansıtacak şekilde düzenleyin.
   ...
   1. Etiketi, `<InstallationTarget>` Visual Studio 2022 ' i yansıtacak şekilde ayarlayın ve AMD64 yükünü belirtin:
...
Bu şekilde, derleme artık hem Visual Studio 2019 hem de Visual Studio 2022 sanal parçaları oluşturuyor.
