...
description: Visual Studio SDK, Visual Studio 'ya özellikleri genişletmenize veya yeni özellikler eklemenize yardımcı olur. Visual Studio 'Yu genişletebilmeniz için bazı yollarla ilgili bilgi edinin.
