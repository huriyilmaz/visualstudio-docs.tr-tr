---
title: IDebugComPlusSymbolProvider::GetFunctionLineOffset | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
Verilen satır ofsetini temsil eden bir işlev içindeki adresi alır.
...
`pAddress`\
[içinde] İşlevtemsil eden adres.

`dwLine`\
[içinde] İşlevin başlangıcından itibaren çizgi ofset.

`ppNewAddress`\
[çıkış] İşlevin başlangıcından itibaren çizgi ofset temsil eden yeni adres.
