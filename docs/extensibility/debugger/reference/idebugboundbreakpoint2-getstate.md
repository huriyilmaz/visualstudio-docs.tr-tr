---
title: IDebugBoundBreakpoint2::GetState | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Bu bağlı kırılma noktasının durumunu alır.
...
`pState`\
[çıkış] Kesme noktasının durumunu açıklayan [BP_STATE](../../../extensibility/debugger/reference/bp-state.md) numaralandırmadan bir değer verir.
