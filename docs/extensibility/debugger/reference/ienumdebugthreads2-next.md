---
description: İş parçacıkları numaralandırmasındaki sonraki öğe kümesini döndürür.
...
`rgelt`\
[in, out] Doldurulacak [IDebugThread2](../../../extensibility/debugger/reference/idebugthread2.md) öğelerinin dizisi.
