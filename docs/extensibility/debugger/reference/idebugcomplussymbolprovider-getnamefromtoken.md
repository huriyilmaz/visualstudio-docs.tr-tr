---
description: Belirtilen belirteçle ilişkili, meta veri nesnesi verilen adı döndürür.
...
`pMetadataImport`\
'ndaki Meta veri bilgilerini içeren nesne.

`dwToken`\
'ndaki Adlandırılacak belirteç.

`pbstrName`\
dışı Belirtece karşılık gelen ad.
