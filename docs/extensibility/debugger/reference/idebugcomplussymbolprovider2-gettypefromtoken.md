---
title: IDebugComPlusSymbolProvider2::GetTypeFromToken | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`tdToken`\
[içinde] Alınacak türün belirteci.

`ppField`\
[çıkış] [IDebugField](../../../extensibility/debugger/reference/idebugfield.md)tarafından temsil edilen türü döndürür.
