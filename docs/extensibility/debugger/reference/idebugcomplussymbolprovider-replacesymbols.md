---
title: IDebugComPlusSymbolProvider::Sembollerdeğiştir | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- ReplaceSymbols
...
ms.locfileid: "80733609"
---
# <a name="idebugcomplussymbolproviderreplacesymbols"></a>IDebugComPlusSymbolProvider::ReplaceSymbols
Geçerli hata ayıklama sembollerini belirtilen veri akışındakilerle değiştirir.
...
`pStream`\
[içinde] Yeni sembolleriçeren veri akışı.
