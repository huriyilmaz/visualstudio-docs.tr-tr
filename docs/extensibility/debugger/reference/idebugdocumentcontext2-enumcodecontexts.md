---
title: IDebugDocumentContext2::EnumCodeContexts | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
ms.locfileid: "80731853"
---
# <a name="idebugdocumentcontext2enumcodecontexts"></a>IDebugDocumentContext2::EnumCodeContexts
Bu belge bağlamıyla ilişkili tüm kod bağlamlarının listesini alır.
...
Tek bir belge bağlamı, belge şablonları kullanırken veya dosyalar eklerken birden çok kod bağlamı oluşturabilir.
