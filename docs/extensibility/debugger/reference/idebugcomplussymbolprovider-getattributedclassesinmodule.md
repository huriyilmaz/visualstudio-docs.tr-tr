---
description: Belirli bir modülde belirtilen özniteliğe sahip sınıfları alır.
...
Belirli bir modülde belirtilen özniteliğe sahip sınıfları alır.
...
`ppEnum`\
dışı Öznitelikli sınıfların bir listesini döndürür.
