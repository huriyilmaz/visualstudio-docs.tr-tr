---
description: Numaralamadan sonraki DEBUG_PROPERTY_INFO öğelerini döndürür.
...
`rgelt`\
[in, out] Doldurulması [DEBUG_PROPERTY_INFO](../../../extensibility/debugger/reference/debug-property-info.md) öğe dizisi.
