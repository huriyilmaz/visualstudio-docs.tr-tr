---
description: Sınırsız hale gelen kesme noktası alır.
...
ms.locfileid: "122145243"
---
# <a name="idebugbreakpointunboundevent2getbreakpoint"></a>IDebugBreakpointUnboundEvent2::GetBreakpoint
Sınırsız hale gelen kesme noktası alır.
...
`ppBP`\
[out] Sınırsız hale gelen kesme noktası temsil eden [bir IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) nesnesi döndürür.
