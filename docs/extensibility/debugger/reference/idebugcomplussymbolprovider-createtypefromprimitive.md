---
title: IDebugComPlusSymbolProvider::CreateTypeFromPrimitive | Microsoft Dokümanlar
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppType`\
[içinde] Türü açıklayan bir [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) nesnesi döndürür.
