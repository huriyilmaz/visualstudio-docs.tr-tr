...
2. **Model Düzenleyicisi** araç çubuğunda, **Komutlar** Araçlar ' ı seçerek  >    >  **Çokgen seçiminden yeni nesne oluştur**' u seçin.
...
İki nesne arasındaki üst-alt öğe ilişkilendirmesini kaldırmak için, alt nesneyi seçin ve ardından **Model Düzenleyicisi** araç çubuğunda,   >  ana bilgisayardan betikler **sahne yönetimi**  >  **Ayır**' ı seçin. Üst nesne ile alt nesneyi ayırdığınızda, alt nesne sahnede bir kök nesne olur.
