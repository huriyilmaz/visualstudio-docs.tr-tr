...
description: Visual Studio 'Yu kullanarak 3B varlıkları işleme ve bunları yapılara ekleme hakkında bilgi edinin. Visual Studio, oluşturduğu her varlık için derleme özelleştirmeleri sağlar.
