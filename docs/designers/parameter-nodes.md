...
|**Saat**|Saniye cinsinden süre.<br /><br /> Bunu gölgelendirici hesaplamalarında bir parametre olarak kullanabilirsiniz. Örneğin doku koordinatlarına, renk değerlerine veya diğer özniteliklere animasyon uygulayabilirsiniz.<br /><br /> **Çıktıların**<br /><br /> `Output`: `float`<br /> Saniye cinsinden süre.|Yok|