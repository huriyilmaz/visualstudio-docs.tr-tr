...
description: Visual Studio hata ayıklama arabirimi erişim SDK 'sında compiland sembol türü (SymTagCompiland) hakkında başvuru bilgileri bulun.
