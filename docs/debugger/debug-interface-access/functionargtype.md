---
description: Bir işlevin her parametresi bir SymTagFunctionArgType simgesiyle tanımlanır.
...
ms.locfileid: "126630584"
---
# <a name="functionargtype"></a>FunctionArgType
Bir işlevin her parametresi bir sembolle `SymTagFunctionArgType` tanımlanır.
...
|--------------|---------------|-----------------|
|[IDiaSymbol::get_classParent](../../debugger/debug-interface-access/idiasymbol-get-classparent.md)|`IDiaSymbol*`|FunctionType üst öğesi için sembol.|
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|Döndürür `SymTagFunctionArgType` [(SymTagEnum Numaralama değerlerinden](../../debugger/debug-interface-access/symtagenum.md) biri).|
