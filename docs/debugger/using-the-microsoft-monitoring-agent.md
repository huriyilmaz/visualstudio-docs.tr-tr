...
2. 32 bit sürümü **MMASetup-i386.exe** veya 64 bit sürümü **MMASetup-AMD64.exe** olan [ücretsiz Microsoft Monitoring Agent](https://visualstudio.microsoft.com/vs/older-downloads/#visual-studio-2015-and-other-products), Microsoft indirme merkezi 'nden web sunucunuza indirin.
...
3. Günlüğü güvenli bir paylaşılan klasöre kopyalayın ve ardından günlüğü Visual Studio Enterprise (Professional veya Community) içeren bir bilgisayardan açın.
