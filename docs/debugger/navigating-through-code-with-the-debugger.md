...
- [Belirli bir konuma veya işleve](#run-to-a-specific-location-or-function), örneğin [bir kesme noktası ayarlayıp](using-breakpoints.md) uygulamanızı başlatarak çalıştırın.
