...
| **SQL hata ayıklama** (tümü, MPI kümesi hata ayıklayıcısı) | Uygulamanızdan SQL yordamlarını hata ayıklamasına izin vermez [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] . Varsayılan ayar Hayır ' dır. |
