...
1. DLL projesi açıkken, Windows anında **Hata Ayıkla**' yı seçerek **Immediate**  >  **Windows**  >  **Immediate** veya **CTRL** + **alt** + **I**tuşlarına basarak hemen pencereyi açın.
