...
ms.locfileid: "126626498"
---
# <a name="expressions-in-the-visual-studio-debugger"></a>Hata ayıklayıcısında Visual Studio ifadeleri
Hata Visual Studio, **QuickWatch** iletişim kutusuna, İzleme penceresine veya Anlık pencereye bir ifade  **girebilirsiniz.** İfade değerlendiricileri, Kesme Noktaları penceresinde **ve hata** ayıklayıcıda birçok farklı yerde de çalışır.
