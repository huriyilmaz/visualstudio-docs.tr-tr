...
description: Visual Studio hata ayıklayıcısının özelliklerini ve hata ayıklayıcıyı başlatmayı, kodu adım adım incelemeyi ve bir C++ uygulamasındaki verileri incelemeyi öğrenin.
...
3. Sol **bölmede yeni Project** iletişim kutusunda, Visual C++'ı **genişletin** ve Windows **Masaüstü'Windows seçin.** Orta bölmede Konsol **Uygulaması'Windows seçin.** Ardından projeye *get-started-debugging adını girin.*
...
1. Yeni **proje oluştur penceresinde** arama kutusuna *konsol yazın* veya yazın. Ardından Dil **listesinden C++** 'ı seçin ve ardından **Platform Windows'yi** seçin. 
...
1. *get-started-debugging.cpp* dosyasında varsayılan kodun tüm yerine aşağıdaki kodu girin:
