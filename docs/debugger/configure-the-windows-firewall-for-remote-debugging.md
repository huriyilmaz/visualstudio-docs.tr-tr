...
Belirli uygulamaların güvenlik duvarı üzerinden Windows için bkz. Güvenlik [Duvarı üzerinden uzaktan hata Windows yapılandırma.](#configure-remote-debugging-through-windows-firewall)
