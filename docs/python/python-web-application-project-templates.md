...
Tüm **Boş \<framework> Web Project** şablonları, az veya çok az ortak koda ve birrequirements.txtdosyasında bildirilen gerekli *bağımlılıklara sahip bir proje* oluşturur.
...
**Anketler \<framework> Web Project** şablonları, kullanıcıların farklı yoklama sorularına oy verecekleri bir başlangıç web uygulaması oluşturur. Her uygulama, yoklamaları ve kullanıcı yanıtlarını yönetmek için bir veritabanı kullanmak üzere **Web** projesi şablonlarının yapısı üzerine kurulur. Uygulamalar, uygun veri modellerini ve dosya üzerinde bir dosyadan gelen yoklamaları yüksamples.jsuygulama *sayfasını (/seed)* içerir.
...
Kaynak denetimi kullanıyorsanız, genellikle sanal ortam klasörünü atlarsınız çünkü bu ortam yalnızca *requirements.txt.* Klasörü dışlamanın en iyi yolu,  önce yukarıda gösterilen istemde kendi yükleyeceğim öğesini seçmek ve ardından sanal ortamı oluşturmadan önce otomatik işlemeyi devre dışı bırakmaktır. Ayrıntılar için bkz. [Learn Django Öğreticisi - Adım 1-2 ve 1-3](learn-django-in-visual-studio-step-01-project-and-solution.md#step-1-2-examine-the-git-controls-and-publish-to-a-remote-repository) ve [Learn Flask Öğreticisi - 1-2 ve 1-3. Adımlar.](learn-flask-visual-studio-step-01-project-solution.md#step-1-2-examine-the-git-controls-and-publish-to-a-remote-repository)

Microsoft Azure App Service dağıtım Microsoft Azure App Service python sürümünü site uzantısı olarak [seçin ve](./managing-python-on-azure-app-service.md?view=vs-2019&preserve-view=true) paketleri el ile yükleyin. Ayrıca, Azure App Service **bir** requirements.txtdosyasından paketleri  otomatik olarak yüklemez, Visual Studio'de yapılandırma [ayrıntılarını aka.ms/PythonOnAppService.](managing-python-on-azure-app-service.md)
