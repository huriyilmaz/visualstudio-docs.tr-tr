---
title: docker kapsayıcısını Azure Container Registry ASP.NET dağıtma
...
* [Windows Için Docker Desktop](https://docs.docker.com/desktop/windows/install/) 'ı yükler
::: moniker-end
...
* "ASP.NET ve web geliştirme" iş yüküne sahip [Visual Studio 2022 RC](https://visualstudio.microsoft.com/downloads) 'nin en son sürümünü yükler
* [Windows Için Docker Desktop](https://docs.docker.com/desktop/windows/install/) 'ı yükler
:::moniker-end
...
4. **Yeni Azure Container Registry oluştur ' a** istediğiniz değerleri girin.
    ...
    ![Visual Studio Azure Container Registry oluştur iletişim kutusunu gösteren ekran görüntüsü.](media/hosting-web-apps-in-docker/vs-azure-container-registry-provisioning-dialog.png)
...
4. **Azure Container Registry** ekranında istediğiniz değerleri girin.
    ...
    ![Visual Studio Azure Container Registry oluştur iletişim kutusunun ekran görüntüsü.](media/hosting-web-apps-in-docker/vs-azure-container-registry-provisioning-dialog-2019.png)
...
2. **Yayımla** Iletişim kutusunda **Docker Container Registry** öğesini seçin.
   ...
   ![Yayımla iletişim kutusunun ekran görüntüsü-Docker Container Registry seçin.](media/container-tools/vs-2022/docker-container-registry.png)

3. **Yeni Azure Container Registry oluştur** öğesini seçin.
 
   ![Yayımla iletişim kutusunun ekran görüntüsü-yeni Azure Container Registry oluştur seçeneğini belirleyin.](media/container-tools/vs-2022/select-existing-or-create-new-azure-container-registry.png)
...
4. **Azure Container Registry** ekranında istediğiniz değerleri girin.
    ...
    ![Visual Studio Azure Container Registry oluştur iletişim kutusunun ekran görüntüsü.](media/container-tools/vs-2022/vs-azure-container-registry-provisioning-dialog.png)
