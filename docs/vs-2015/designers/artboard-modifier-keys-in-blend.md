...
|Çalışma yüzeyini yakınlaştırma|Çalışma yüzeyinde herhangi bir yere tıklarken CTRL + Ara çubuğu tuşunu basılı tutun|
|Çalışma yüzeyinde uzaklaştır|Çalışma yüzeyinde herhangi bir yere tıklarken CTRL + ALT + ara çubuğu tuşlarını basılı tutun|
...
|**Varlıklar** panelini açın|CTRL + PERIOD tuşlarına basın|

## <a name="see-also"></a>Ayrıca Bkz.
 [Klavye kısayolları](../designers/keyboard-shortcuts-in-blend.md) [Kalem aracı değiştirici tuşları](../designers/pen-tool-modifier-keys-in-blend.md) [doğrudan seçim araç değiştirici tuşları](../designers/direct-selection-tool-modifier-keys-in-blend.md)
