---
title: Verileri Blend 'de görüntüle | Microsoft Docs
ms.date: 11/15/2016
...
Sayfalarınızın yerleşimini özelleştirirken, tasarımcılarınızdan örnek verileri görüntüleyebilirsiniz. Sıfırdan örnek veri oluşturabilir veya var olan bir sınıfı kullanarak oluşturabilirsiniz. Ayrıca, çalıştırdığınızda uygulamanızda görüntülenecek *canlı verilere* de bağlanabilirsiniz.
...
- [Bir WPF uygulamasında canlı verileri gösterme](#LiveWPF)
 ...
 **Kısa bir video izleyin:** ![yüklü özellikleri yapılandırma](../designers/media/bldadminconsoleinitialconfigicon.PNG "Bldadminconsoleınitialconfigıcon") [sıfırdan örnek veri oluşturma](https://www.bing.com/videos/search?q=blend%20data&qs=n&form=QBVR&pq=blend%20data&sc=8-7&sp=-1&sk=#view=detail&mid=F8F2449A76956D480FD2F8F2449A76956D480FD2).
