...
|**Adobe resim kullanma**|Desteklenmez.|Adobe FXG, PhotoShop veya Illustrator resimlerini içeri aktarın ve Visual Studio için Blend içinde Kullanıcı arabirimini uygulayın.|[Görüntü, video ve ses klipleri ekleme](../designers/insert-images-videos-and-audio-clips-in-xaml-designer.md)|
