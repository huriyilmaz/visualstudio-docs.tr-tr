...
Bu bölümde, [t] <xref:System.Xml.Linq.XElement?displayProperty=fullName> dinamik özellikleri açıklanmaktadır (<!-- TODO: review code entity reference <xref:assetId:///t?qualifyHint=False&amp;autoUpgrade=True>  -->sınıfı.
...
|[Xml](../designers/xml-xelement-dynamic-property.md)|Bir öğenin biçimlendirilmemiş XML temsilini alır.|

## <a name="see-also"></a>Ayrıca Bkz.
 <xref:System.Xml.Linq.XElement?displayProperty=fullName> [LINQ to XML dinamik özellikler](../designers/linq-to-xml-dynamic-properties.md) [XAttribute sınıfı dinamik özellikleri](../designers/xattribute-class-dynamic-properties.md)
