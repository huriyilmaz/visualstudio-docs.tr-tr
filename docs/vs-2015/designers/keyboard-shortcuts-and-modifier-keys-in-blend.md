...
ms.locfileid: "74300813"
---
# <a name="keyboard-shortcuts-and-modifier-keys-in-blend"></a>Blend’de klavye kısayolları ve değiştirici tuşlar
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Klavye kısayolları, tek bir klavye kısayoluna birden çok fare düğmesi tıklamasını gerektiren bir eylemi azaltarak çalışmanızı hızlandırabilir. [!INCLUDE[blend_first](../includes/blend-first-md.md)] klavye kısayolları aşağıdaki iki kategoride gelir:
...
- **Kısayol tuşları** Klavye kısayoluna basarak bir eylem gerçekleştirmek için kısayol tuşlarını kullanabilirsiniz (bir menü komutu seçme veya bir araç davranışını değiştirme gibi).
  ...
  Erişilebilirlik ve özellikler hakkında daha fazla bilgi için bkz. [Microsoft 'Ta erişilebilirlik](https://go.microsoft.com/fwlink/?LinkId=75069).
