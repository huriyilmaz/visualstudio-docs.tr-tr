---
title: 'İzlenecek yol: Windows formunda hata ayıklama | Microsoft Docs'
ms.date: 11/15/2016
...
2. Proje türleri bölmesinde **Visual Basic**, **Visual C#** veya **Visual C++** düğümünü açın, sonra  
    ...
    1. Visual Basic veya Visual C# için **Windows** düğümünü seçin, sonra **Şablonlar** bölmesinde **Windows form uygulaması** ' nı seçin.  
  
    2. Visual C++ için **clr** düğümünü seçin ve ardından **Şablonlar** bölmesinde **Windows form uygulaması** ' nı seçin.  
  
3. **Şablonlar** bölmesinde **Windows uygulaması**' nı seçin.  
  
4. **Ad** kutusunda projeye benzersiz bir ad verin (örneğin, Walkthrough_SimpleDebug).  
  
5. **Tamam**’a tıklayın.  
  
     Visual Studio, yeni bir proje oluşturur ve Windows Forms Tasarımcısı'nda yeni bir form görüntüler. Daha fazla bilgi için bkz. [Windows Form Tasarımcısı](https://msdn.microsoft.com/3c3d61f8-f36c-4d41-b9c3-398376fabb15).  
  
6. **Görünüm** menüsünde **araç kutusu**' nu seçin.  
  
     Araç Kutusu açılır. Daha fazla bilgi için bkz. [araç kutusu](../ide/reference/toolbox.md).  
  
7. Araç kutusunda, **düğme** denetimine tıklayın ve denetimi form tasarım yüzeyine sürükleyin. Düğmeyi form üzerine bırakın.  
  
8. Araç kutusunda **metin kutusu** denetimine tıklayın ve denetimi form tasarım yüzeyine sürükleyin. **Metin kutusunu** formun üzerine bırakın.  
...
5. **Watch1** penceresinde boş bir satıra tıklayın. **Ad** sütununda, `textBox1.Text` (Visual Basic, Visual C# veya J# kullanıyorsanız) veya `textBox1->Text` (C++ kullanıyorsanız) yazın, ardından ENTER tuşuna basın.  
