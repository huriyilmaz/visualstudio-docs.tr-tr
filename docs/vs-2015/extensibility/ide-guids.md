...
<xref:Microsoft.VisualStudio.VSConstants>Sınıfı, aşağıdaki tabloda listelendiği gibi tümleşik geliştirme ortamının (IDE) bazı bölümlerinin GUID 'lerini yayımlar.  
  
## <a name="core-systems"></a>Çekirdek sistemler  
...
## <a name="broadly-visible-components"></a>Büyük ölçüde görünür bileşenler  
  
|Sabit|GUID|  
|--------------|----------|  
|<xref:Microsoft.VisualStudio.VSConstants.CLSID.VsUIHierarchyWindow_guid>|7D960B07-7AF8-11D0-8E5E-00A0C911005A|  
|<xref:Microsoft.VisualStudio.VSConstants.VsEditorFactoryGuid.ExternalEditor_guid>|8137C9E8-35FE-4AFıCE87B0-DE3C45F395FD|  
|Microsoft. VisualStudio. Vssabitleri. SID_SUIHostCommandDispatcher|e69cd190-1276-11d1-9f64-00a0c911004f|  
|Microsoft. VisualStudio. Vssabitleri. SID_SVsGeneralOutputWindowPane|65482c72-defa-41b7-902c-11c091889c83|  
...
|<xref:Microsoft.VisualStudio.VSConstants.UICONTEXT.SolutionHasMultipleProjects_guid>|93694fa0-@2 7-11D1-9f4e-00a0c911004f|  
...
## <a name="command-sets-and-properties"></a>Komut kümeleri ve Özellikler  
  
|Sabit|GUID|  
|--------------|----------|  
|Microsoft. VisualStudio. Vssabitleri. GUID_VSStandardCommandSet97|5EFC7975-14BC-11CF-9B2B-00AA00573819|  
|Microsoft. VisualStudio. Vssabitleri. GUID_VsUIHierarchyWindowCmds|60481700-078b-11D1-AAF8-00a0c9055a90|  
...
## <a name="component-selector-page-guids"></a>Bileşen Seçicisi sayfa GUID 'Leri  
  
|Sabitler|GUID|  
|---------------|----------|  
|Microsoft. VisualStudio. Vssabitleri. GUID_COMClassicPage|9A341D96-5A64-11d3-BFF9-00C04F990235|  
|Microsoft. VisualStudio. Vssabitleri. GUID_COMPlusPage|9A341D95-5A64-11d3-BFF9-00C04F990235|  
|Microsoft. VisualStudio. Vssabitleri. GUID_SolutionPage|9A341D97-5A64-11d3-BFF9-00C04F990235|  
...
|Microsoft. VisualStudio. Vssabitleri. SID_SVsToolboxActiveXDataProvider|35222106-bb44-11D0-8c46-00c04fc2aae2|  
