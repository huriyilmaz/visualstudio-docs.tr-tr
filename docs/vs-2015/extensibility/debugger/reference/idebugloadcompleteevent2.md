...
## <a name="remarks"></a>Açıklamalar  
 Bu olay durdurma olayıdır ve `EVENT_STOPPING` olay özniteliklerinde bayrağın ayarlanmış olması gerekir.  
