...
## <a name="example"></a>Örnek  
 Bu örnek, Program yayımcısının örneğini oluşturma ve program düğümünü kaydetme işlemlerinin nasıl yapılacağını gösterir. Bu, [Program düğümünü yayımlayan](https://msdn.microsoft.com/d0100e02-4e2b-4e72-9e90-f7bc11777bae)öğreticiden alınmıştır.  
