...
## <a name="notes-for-callers"></a>Arayanlar İçin Notlar  
 Bu arabirim, [IDebugObject](../../../extensibility/debugger/reference/idebugobject.md) arabiriminin bir özelleştirmesi ve arabirimindeki [QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3) kullanılarak elde edilir `IDebugObject` .  
