...
1. **Testüniversalproject**ADLı BIR C# VSIX projesi oluşturun. (**Dosya, yeni, proje** ve ardından **C#, genişletilebilirlik, Visual Studio paketi**). Özel bir **komut** projesi öğe şablonu ekleyin (Çözüm Gezgini, proje düğümüne sağ tıklayın ve **Ekle/yeni öğe**' yi seçin, ardından **genişletilebilirlik**' e gidin). **Testüniversalproject**dosyasını adlandırın.  
...
3. TestUniversalProject.cs açın ve aşağıdaki deyimleri ekleyin `using` :  
...
4. Testüniversalproject sınıfında **Çıkış** penceresine işaret eden bir özel alan ekleyin.  
...
10. Etkin platform projesini alın. Platform projeleri, platforma özgü kod ve kaynakları içeren projelerdir. Aşağıdaki yöntem, <xref:Microsoft.VisualStudio.Shell.Interop.__VSHPROPID7> etkin platform projesini almak için yeni alanı kullanır.  
...
### <a name="detecting-changes-in-platform-projects-and-shared-projects"></a>Platform projelerinde ve paylaşılan projelerde değişiklikler algılanıyor  
...
3. HierarchyEventListener.cs dosyasını açın ve aşağıdaki using deyimlerini ekleyin:  
