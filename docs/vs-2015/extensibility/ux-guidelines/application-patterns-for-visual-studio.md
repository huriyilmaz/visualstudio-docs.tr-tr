...
### <a name="overview"></a>Genel Bakış
 Visual Studio'da kullanılan iki ana pencere türü belge düzenleyicileri ve araç pencereleridir. Nadir, ancak mümkün, büyük modsuz iletişim vardır. Bunların hepsi kabukta modeless olmasına rağmen, desenleri temelde farklıdır. Bu konu, belge pencereleri, araç pencereleri ve modeless iletişim kutuları arasındaki farkı kapsar. Modal iletişim desenleri [Dialogs](../../extensibility/ux-guidelines/application-patterns-for-visual-studio.md#BKMK_Dialogs)kaplıdır.
 ...
 **Belge pencereleri** hemen hemen her zaman belge içinde iyi görüntülenir. Bu, belge düzenleyicisine ek araç pencerelerini düzenlemek için bir "orta sahne" sağlar.
 ...
 Bir **araç penceresi** genellikle ayrı, daha küçük bir pencere olarak görüntülenir – görünür, gizli veya otomatik olarak gizlenmiş olabilir - IDE kenarına karşı daraltılmış. Ancak, bazen penceredeki **Pencere/Yerleştirme** özelliğini işaretleyerek belge içinde iyi bir şekilde sunulurlar. Bu, daha fazla gayrimenkulle sonuçlanır, aynı zamanda yaygın bir tasarım kararı: Visual Studio'ya entegre etmeye çalışırken, özelliğinizin bir araç penceresi mi yoksa belge penceresi mi görüntülemesi gerektiğine karar vermelisiniz.

 Visual Studio'da **modeless diyalogları** teşvik edilmez. Büyük ölçüde, onlar - tanımı gereği - yüzen araç pencereleri ve bu şekilde uygulanmalıdır. Kabuğun yan tarafına sabitlenmiş normal bir araç penceresinin boyutunun çok sınırlayıcı olacağı durumlarda modeless iletişim kutularına izin verilir. Ayrıca, kullanıcının iletişim kutusunu ikincil bir monitöre taşıma olasılığının yüksek olduğu durumlarda da izin verilir.
...
|**Örnekler**|**Metin düzenleyicileri**, kod düzenleyicisi gibi<br /><br /> Form tasarımcısı veya modelleme yüzeyi gibi **tasarım yüzeyleri**<br /><br /> Bildirim Tasarımcısı gibi **iletişim kutularına benzer denetim düzenleri**|**Çözüm Gezgini** bir çözüm ve çözüm içinde yer alan projeler sağlar<br /><br /> **Sunucu Gezgini,** kullanıcının pencerede açmayı seçtiği sunucuların ve veri bağlantılarının hiyerarşik görünümünü sağlar. Sorgu gibi veritabanı hiyerarşisinden bir nesne açmak, belge penceresini açar ve kullanıcının sorguyu düzenleyicisine olanak tanır.<br /><br /> **Özellik Tarayıcısı,** belge penceresinde veya başka bir araç penceresinde seçilen nesnenin özelliklerini görüntüler. Özellikler hiyerarşik kılavuz görünümünde veya karmaşık iletişim kutusu benzeri denetimlerde sunulur ve kullanıcının bu özelliklerin değerlerini ayarlamasına izin verir.||
...
- Göreve uygun varolan araç pencerelerini kullanın ve benzer işlevsellik te yenilerini oluşturmayın. Yeni araç pencereleri yalnızca benzer bir pencereye entegre edilemeyen önemli ölçüde farklı bir "araç" veya işlevsellik sunarsa veya varolan bir pencereyi döner hub'a dönüştürerek oluşturulmalıdır.
...
- Belgeye özgü araç pencereleri, yalnızca üst belge etkinleştirildiğinde görünmesi için mümkün olduğunda otomatik olarak görünür olmalıdır.
...
- **Otomatik gizli** araç pencereleri sabitlenmemiş. Pencere, belge alanının kenarında bir sekme (araç penceresi ve simgesinin adı ile) bırakarak gözden uzak kayar. Bir kullanıcı sekme üzerinde gezinirken araç penceresi dışarı kayar.

- **Otomatik görünür** araç pencereleri, düzenleyici gibi başka bir UI parçası başlatıldığında veya odak landığında otomatik olarak görünür.
...
#### <a name="single-instance-and-multi-instance"></a>Tek örnekli ve çok örnekli
 Araç pencereleri tek örnekli veya çok örneklidir. Bazı tek örnekli araç pencereleri etkin belge penceresiyle ilişkilendirilebilir, ancak çok örnekli araç pencereleri ilişkilendirilmeyebilir. Çok örnekli araç pencereleri pencerenin yeni bir örneğini oluşturarak Pencere/Yeni Pencere komutuna yanıt verir. Aşağıdaki resimde, pencerenin bir örneği etkin olduğunda Yeni Pencere komutunu etkinleştiren bir araç penceresi gösteriş yapılır:
 ...
 **Pencerenin bir örneği etkin olduğunda 'Yeni Pencere' komutunu etkinleştiren araç penceresi**
 ...
 **Visual Studio Window menüsünde pencere yönetimi komutları**
...
|----------|-----------------|--------------|
|**Hiyerarşi**|Çözüm Gezgini|Projelerde, çeşitli dosyalarda ve çözüm öğelerinde bulunan belgelerin listesini görüntüleyen hiyerarşik bir ağaç. Projelerdeki öğelerin görüntülenmesi, proje türüne (örneğin, başvuru tabanlı, dizin tabanlı veya karma mod türleri) sahip olan paket tarafından tanımlanır.|
|**Hiyerarşi**|Sınıf Görünümü|Dosyaların kendisinden bağımsız olarak, çalışma belgeleri kümesindeki sınıfların hiyerarşik ağacı ve çeşitli öğeler.|
...
|**Kılavuz**|Özellikler|Seçili nesnenin özelliklerinin listesini ve bu özellikleri ni örecek değer seçicileri görüntüleyen bir ızgara.|
|**Kılavuz**|Görev Listesi|Kullanıcının görevleri ve açıklamaları oluşturmasına/düzenlemesine/silmesine olanak tanıyan bir ızgara.|
|**İçerik**|Yardım|Kullanıcıların "Nasıl Yardım Yaparım?" adlı yöntemden çeşitli yardım alma yöntemlerine erişmelerini sağlayan bir pencere MSDN forumlarına videolar.|
|**İçerik**|Dinamik Yardım|Geçerli seçimiçin geçerli konulara yardımcı olmak için bağlantıları görüntüleyen bir araç penceresi.|
|**İçerik**|Nesne Tarayıcısı|Sol bölmede hiyerarşik nesne bileşenlerinin ve sağ sütundaki nesnenin özellikleri ve yöntemlerinin bir listesini içeren iki sütunlu çerçeve kümesi.|
|**Iletişim**|Bul, Gelişmiş Bul|Kullanıcının çözüm içindeki çeşitli dosyaları bulmasına veya bulmasına ve değiştirmesine olanak tanıyan bir iletişim kutusu.|
...
|**Diğer**|Başlangıç Sayfası|Geliştirici haber, Visual Studio yardım ve son projelerin beslemeleri erişimi ile Visual Studio kullanıcı portalı. Kullanıcılar ayrıca StartPage.xaml dosyasını "Common7\IDE\StartPages\" Visual Studio program dosya dizininden Visual Studio doküman dizinindeki StartPages klasörüne kopyalayarak ve xaml'ı elle veya elle düzenleyerek özel başlangıç sayfaları oluşturabilirler. Visual Studio veya başka bir kod editörü açılması.|
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Otomobil||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Hemen||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Çıktı|Çıktı penceresi, bildirilecek metinsel olaylar veya durum olduğunda kullanılabilir.|
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Bellek||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Kesme Noktaları||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Çalışıyor||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Belgeler||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Çağrı Yığını||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Yerli||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Saatler||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Demontaj||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|Kayd -eder||
|**Hata ayıklama:** hata ayıklama görevleri ve izleme etkinliklerine özel bir grup pencere|İş Parçacıkları||
...
- Menü komutları, **Edit,** **Biçim**lendirme ve **Görünüm** menüleri gibi ortak menülere uygun şekilde entegre edilmiştir. Önemli miktarda özel komut varsa, yalnızca belgenin odağı olduğunda görülebilen yeni bir menü oluşturulabilir.
...
3. Etkileşim ve düzen yönergelerini izleyerek yeni bir iletişim kutusu oluşturun.
   ...
   Bu konu, Visual Studio iş akışları içinde doğru iletişim deseni ve iletişim tasarımı için ortak kuralları nasıl seçeceğini açıklar.
...
#### <a name="standard-unthemed"></a>Standart (temalı olmayan)
 İletişim kutularının çoğu standart yardımcı program iletişim leridir ve temalı olmalıdır. Ortak denetimleri yeniden şablona alma veya stilize edilmiş "modern" düğmeler veya denetimler oluşturmaya çalışmayın. Denetimler ve krom görünümü [iletişim kutuları için standart Windows Masaüstü etkileşim yönergeleriizleyin.](https://msdn.microsoft.com/library/windows/desktop/dn742499\(v=vs.85\).aspx)
...
- İletişim, bir ürün sürümünün tanıtımında veya farklılaştırılmasında stratejik rol oynayan bir deneyimin önemli bir parçasıdır.
  ...
  Temalı bir iletişim kutusu oluştururken, uygun ortam renklerini kullanın ve doğru düzeni ve etkileşim desenlerini izleyin. [(Bkz. Görsel Stüdyo düzeni)](../../extensibility/ux-guidelines/layout-for-visual-studio.md)
...
#### <a name="simple-dialogs"></a><a name="BKMK_SimpleDialogs"></a>Basit iletişim kutuları
 ...
 ![Visual Studio'da basit iletişim](../../extensibility/ux-guidelines/media/0704-01-createstrongnamekey.png "0704-01_CreateStrongNameKey")

 **Güçlü Ad Anahtarı Oluştur, Visual Studio'daki basit bir iletişim ekidir.**
 ...
 **Araçlar > Seçenekleri** iletişim kutusu, katıştırılmış bir ağaç kullanarak katmanlı bir iletişim kutusunun bir örneğidir:
 ...
 **Araçlar > Seçenekleri, Visual Studio'daki katmanlı bir iletişim ekidir.**
...
#### <a name="position"></a>Konum
 İlk başlatmada IDE içinde ortalanmış diyaloglar görünmelidir. Yeniden boyutlandırılamayan iletişim kutuları için, iletişim kutusunun son konumunun kalıcı olması gerekmez, bu nedenle sonraki başlatışlarda ortalanmış olarak görünür. Yeniden boyutlandırılabilir iletişim için boyut sonraki başlatışlarda kalıcı olmalıdır. Modal olan yeniden boyutlandırılabilir iletişim ler için pozisyonun kalıcı olması gerekmez. Bunları IDE içinde ortalanmış olarak görüntülemek, kullanıcının görüntü yapılandırması değiştiğinde iletişim kutusunun öngörülemeyen veya kullanılamaz bir konumda görüntülenme olasılığını önler. Yeniden konumlandırılabilen modeless iletişim kutuları için, iletişim kutusu daha büyük bir iş akışının ayrılmaz bir parçası olarak sık sık kullanılabilebileceğinden, kullanıcının konumu sonraki başlatışlarda tutulmalıdır.

 İletişim iletişimlerinin diğer iletişim leri üretmesi gerektiğinde, en üstteki iletişim kutusu üstten sağa ve aşağıya basamaklanmalıdır, böylece kullanıcıya yeni bir yere yön ettikleri açık olur.
...
#### <a name="modality"></a>Modalite
 ...
 Kullanıcıların yeni kod yazarken **Bul** ve **Değiştir** gibi aynı anda iki etkinlik gerçekleştirmesi gerektiğinde, iletişim kutusunun modsuz olması gerekir, böylece kullanıcı aralarında kolayca geçiş yapabilir. Visual Studio genellikle bu tür düzenleyici destekli bağlantılı görev için araç pencerelerini kullanır.
...
- Başlık çubuğundaki yardım düğmeleri küçümsülmüş. Bunları yeni iletişim kutularına eklemeyin. Var olduklarında, görevle kavramsal olarak alakalı bir Yardım konusunu başlatmaları gerekir.
  ...
  ![Visual Studio için başlık çubuğu özellikleri](../../extensibility/ux-guidelines/media/0704-03-titlebarspecs.png "0704-03_TitleBarSpecs")
...
#### <a name="control-buttons"></a>Kontrol düğmeleri
 Genel olarak, **Tamam**/**İptal**/**Yardımı** düğmeleri iletişim kutusunun sağ alt köşesinde yatay olarak düzenlenmelidir. Bir iletişim kutusunun alt kısmında denetim düğmeleriyle görsel karışıklık oluşturan birkaç başka düğme varsa, alternatif dikey yığına izin verilir.

 ![Visual Studio'da kontrol düğmesi yapılandırmaları](../../extensibility/ux-guidelines/media/0704-04-controlbuttonconfig.png "0704-04_ControlButtonConfig")

 **Visual Studio iletişim kutularında denetim düğmeleri için kabul edilebilir yapılandırmalar**
 ...
 **OK**/**Cancel**Tamam/**İptal Yardımı** düğmeleri için erişim tuşlarını kullanmayın. Bu düğmeler varsayılan olarak kısayol tuşlarına eşlenir:
...
|Ağaç denetimi|Sınırsız kategorilere izin verir<br /><br /> Kategorilerin gruplandırmave/veya hiyerarşisine izin verir<br /><br /> Genişletilebilir<br /><br /> Örnek: **Araçlar > Seçenekleri**|Ağır iç içe olan hiyerarşiler aşırı yatay kaydırmaya neden olabilir<br /><br /> Visual Studio ağaç görünümleri bir bolluk vardır|
|Sihirbazı|Görev tabanlı, sıralı adımlararacılığıyla yol gösterici olarak görev tamamlamada yardımcı olur. Sihirbaz üst düzey bir görevi temsil eder ve tek tek paneller genel görevi gerçekleştirmek için gereken alt görevleri temsil eder.<br /><br /> Görev Ui sınırlarını aştığında yararlıdır, kullanıcı görevi tamamlamak için birden çok düzenleyici ve araç penceresi kullanmak zorunda kaldığında<br /><br /> Görev dallanma gerektirdiğinde yararlı<br /><br /> Görev adımlar arasındaki bağımlılıkları içerdiğinde yararlı<br /><br /> Farklı benzer iletişim iletişimlerinin sayısını azaltmak için tek bir karar çatalı yla birlikte birkaç benzer görev tek bir iletişim kutusunda sunulabilirse yararlıdır.|Sıralı iş akışı gerektirmeyen herhangi bir görev için uygun olmayan<br /><br /> Kullanıcılar çok fazla adımla bir sihirbaz tarafından bunalmış ve kafası karışabilir<br /><br /> Sihirbazlar doğal olarak sınırlı ekran gayrimenkul var|
 ...
 **Outlook'ta ek ui açığa çıkarmak için koridor kavramı**

##### <a name="adaptive-ui"></a>Uyarlanabilir UI
 Kullanıcı Arabirimi'ni kullanıma veya kullanıcının kendi kendine bildirilen deneyimine göre gösterme veya gizleme, diğer bölümleri gizlerken gerekli Kullanıcı Arabirimi'ni sunmanın başka bir yoludur. Bu, Kullanıcı Arabirimi'ni ne zaman göstereceğine veya gizleyeceğine karar vermek için algoritmalar zor olabileceğinden visual Studio'da önerilmez ve kurallar bazı durumlarda her zaman yanlış olacaktır.
...
- Başvuru tabanlı ve karma proje sistemleri, kaynak öğeye bağlantı (veya başvuru) ekleme kavramını destekler. Bu projeler sürükle ve bırak işleminin hedefi olduğunda **(Ctrl + Shift** tutulduğunda), projeye eklenen öğeye bir başvuru yla sonuçlanmalıdır
  ...
  Sürükle ve bırak davranışını düzgün bir şekilde uygulamak için sürüklenin kaynak projesinin doğasını (örneğin, başvuru veya dizin tabanlı mı?) hedef projeye iletmesi gerekir. Bu bilgiler, kaynak tarafından sunulan pano biçimi yle gösterilir. Sürükleme (veya pano kopyalama işleminin kaynağı) olarak, projenin referans tabanlı mı yoksa dizin tabanlı mı olduğuna bağlı olarak, bir proje sırasıyla **CF_VSREFPROJECTITEM**S veya **CF_VSSTGPROJECTITEMS** sunmalıdır. Bu biçimlerin her ikisi de, dosya adı olmak yerine dizeler listelerinin yerine, Windows **CF_HDROP** biçimine benzer aynı veri içeriğine sahiptir, **Projref** dizeleri çift**geçersiz** kılınmış bir listedir **(IVsSolution'tan döndürüldürün::GetProjrefOfItem** veya **::GetProjrefOfProject** uygun olarak).

  Bir damla (veya pano yapıştırma işleminin) hedefi olarak, bir proje hem **CF_VSREFPROJECTITEMS** hem de **CF_VSSTGPROJECTITEMS**kabul etmelidir, ancak sürükle ve bırak işleminin tam olarak işlenmesi hedef projenin ve kaynak projenin niteliğine bağlı olarak değişir. Kaynak **proje, CF_VSREFPROJECTITEMS** veya **CF_VSSTGPROJECTITEMS**sunup sunmadığı na göre doğasını beyan eder. Bırakmanın hedefi kendi doğasını anlar ve böylece bir taşımanın, kopyalamanın veya bağlantının gerçekleştirilip gerçekleştirilmeyeceğine karar vermek için yeterli bilgiye sahiptir. Kullanıcı ayrıca Ctrl, Shift veya hem Ctrl hem de Shift tuşlarına basarak hangi sürükle ve bırak işleminin yapılması gerektiğini de değiştirir. Açılan hedefin **DragEnter** ve **DragOver** yöntemlerinde hangi işlemin önceden gerçekleştirileceğini doğru şekilde belirtmesi önemlidir. **Çözüm Gezgini,** kaynak proje ile hedef projenin aynı proje olup olmadığını otomatik olarak bilir.
...
|-------------------|-------------|-----------------|
|![Fare "damla yok" simgesi](../../extensibility/ux-guidelines/media/0706-01-mousenodrop.png "0706-01_MouseNoDrop")|Damla yok|Öğe belirtilen konuma bırakılamaz.|
|![Fare "kopyala" simgesi](../../extensibility/ux-guidelines/media/0706-02-mousecopy.png "0706-02_MouseCopy")|Kopyala|Öğe hedef konuma kopyalanır.|
|![Fare "taşı" simgesi](../../extensibility/ux-guidelines/media/0706-03-mousemove.png "0706-03_MouseMove")|Taşı|Öğe hedef konuma taşınır.|
|![Fare "referans ekle" simgesi](../../extensibility/ux-guidelines/media/0706-04-mouseaddref.png "0706-04_MouseAddRef")|Başvuru ekleme|Seçili öğeye bir başvuru hedef konuma eklenir.|
...
|Değiştirici yok|Sonuç|**DROPEFFECT_MOVE** **DROPEFFECT_MOVE::Drop'tan** eylem olarak döndürülür ve öğe depoda orijinal konumda kalır|**DROPEFFECT_LINK** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|
...
|Shift+Sürükleme|Sonuç|**DROPEFFECT_MOVE** **DROPEFFECT_MOVE::Drop'tan** eylem olarak döndürülür ve öğe depoda orijinal konumda kalır|Damla yok|
...
|Ctrl+Sürükleme|Sonuç|**DROPEFFECT_COPY** **::Drop'tan** eylem olarak döndürülür ve öğe depoda orijinal konumda kalır|Damla yok|
...
|Ctrl+Shift+Sürükleme|Sonuç|**DROPEFFECT_LINK** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_LINK** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|
...
|Değiştirici yok|Sonuç|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|
...
|Shift+Sürükleme|Sonuç|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|
...
|Ctrl+Sürükleme|Sonuç|**DROPEFFECT_** **COPY::Drop'tan** eylem olarak döndürülür ve öğe depoda orijinal konumda kalır|**DROPEFFECT_** **COPY::Drop'tan** eylem olarak döndürülür ve öğe depoda orijinal konumda kalır|
...
|Değiştirici yok|Kaynak|Özgün öğeye başvuruyaz|Özgün öğeye başvuruyaz|
|Değiştirici yok|Sonuç|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_ MOVE** **::Drop'tan** eylem olarak döndürülür ve öğe depodaki orijinal konumdan silinir|
|Shift+Sürükleme|Eylem|Taşı|Taşı|
|Shift+Sürükleme|Hedef|Özgün öğeye başvuru ekler|Öğeyi hedef konuma kopyalar|
|Shift+Sürükleme|Kaynak|Özgün öğeye başvuruyaz|Öğeyi özgün konumdan siler|
|Shift+Sürükleme|Sonuç|**DROPEFFECT_ MOVE** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_ MOVE** **::Drop'tan** eylem olarak döndürülür ve öğe depodaki orijinal konumdan silinir|
|Ctrl+Sürükleme|Eylem|Kopyala|Kopyala|
...
|Ctrl+Shift+Sürükleme|Kaynak|Özgün öğeye başvurututar|Özgün öğeyi korur|
|Ctrl+Shift+Sürükleme|Sonuç|**DROPEFFECT_ LINK** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|**DROPEFFECT_ LINK** eylem olarak döndürülür **::Drop** ve öğe depolama orijinal konumda kalır|
|Kes/Yapıştır|Eylem|Taşı|Taşı|
|Kes/Yapıştır|Hedef|Öğeyi hedef konuma kopyalar|Öğeyi hedef konuma kopyalar|
|Kes/Yapıştır|Kaynak|Özgün öğeye başvuruyaz|Öğeyi özgün konumdan siler|
|Kes/Yapıştır|Sonuç|Öğe depolamada orijinal konumda kalır|Öğe depolamadaki orijinal konumdan silinir|
...
2. Açık düzenleyici/tasarımcıda kaydedilmemiş değişiklikler varsa, sürüklenin kaynağı damlanın gerçekleşmesini beklemeli ve ardından pencereyi aşağıdaki gibi bir istemle kapatmadan önce kullanıcıdan açık belgelerdeki kaydedilmemiş değişiklikleri kaydetmesini istemelidir:
   ...
   Bu, kullanıcıya hedef kopyalarını yapmadan önce devam eden çalışmaları kaydetme fırsatı verir. Bu işleme etkinleştirmek için yeni bir yöntem **IVsHiyerarşiYDropDataSource2::OnBeforeDropNotify** eklendi.

   Hedef daha sonra öğenin durumunu depolama alanında olduğu gibi kopyalar (kullanıcı **Hayır'ı**seçerse düzenleyicideki kaydedilmemiş değişiklikler dahil değildir). Hedef kopyalamaişlemini tamamladıktan sonra **(IVsHiyerarşiDropDataSource::Drop'ta),** kaynağa taşıma işleminin silme işleminin silme kısmını tamamlama fırsatı verilir **(IVsHiyerarşiYDropDataSource::OnDropNotify'da).**
