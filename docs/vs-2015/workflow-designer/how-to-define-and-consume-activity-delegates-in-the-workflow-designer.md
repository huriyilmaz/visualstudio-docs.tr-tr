...
1. @No__t_0 ' de **Dosya**, **Yeni**, **Proje**' yi seçin. Sol taraftaki **Iş akışı** düğümünü ve sağ taraftaki **Iş akışı konsol uygulaması** şablonunu seçin. Projeyi (isterseniz) adlandırın ve **Tamam**' a tıklayın.
...
9. Tür tarayıcısında, **tür adı** alanına **ActivityAction** girin. Ağaç görünümünde **ActivityAction \<T >** seçin. **ActivityAction > \<Object** türünün bağımsız değişkenine atanması için görüntülenen açılan menüden **nesne** ' yi seçin.
...
11. @No__t_0 etkinliğini seçin ve **değişkenler** sekmesini seçin.
...
14. @No__t_1 etkinliğinin **Condition** özelliğini **< Items. length; dizinine**ayarlayın.
...
17. @No__t_1 etkinliğinin **Özellikler** kılavuzunda... öğesine tıklayın **.** düğmesine basın.
...
19. @No__t_0 etkinliğini <xref:System.Activities.Statements.InvokeDelegate> etkinliğinin altındaki yatay satıra sürükleyin. @No__t_0 etkinliği oluşturulur ve **MyForEach** etkinliğinin **gövde** bölümünde iki etkinliği içerecek şekilde bir <xref:System.Activities.Statements.Sequence> etkinlik otomatik olarak oluşturulur. **Body** bölümü yalnızca tek bir etkinlik içerebileceğinden, bu sıra gereklidir. Yeni bir <xref:System.Activities.Statements.Sequence> etkinliğinin otomatik olarak oluşturulması, [!INCLUDE[net_v45](../includes/net-v45-md.md)] yeni bir özelliğidir.

20. @No__t_1 etkinliğinin **to** özelliğini **index**olarak ayarlayın. **Assign** etkinliğinin **Value** özelliğini **index + 1**olarak ayarlayın.
