...
|------------------|--------------|-----------------|
|**State**|[StateActivity](https://go.microsoft.com/fwlink?LinkID=65042)|Durum makinesindeki bir durumu temsil eder; , ek **StateActivity** etkinlikleri içerebilir. Daha fazla bilgi için bkz. [StateActivity etkinliğini kullanma](https://go.microsoft.com/fwlink?LinkID=65083).|
