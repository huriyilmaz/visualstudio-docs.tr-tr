...
- XmlDocument veya XmlTextReader türetilmiş sınıflar için bir Oluşturucu tanımlanmadı veya <xref:System.Xml.XmlResolver>için hiçbir güvenli değer kullanılmadı.
