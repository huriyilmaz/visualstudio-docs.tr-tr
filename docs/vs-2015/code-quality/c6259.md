...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kod bu uyarıyı oluşturur çünkü ifade `switch``(rand() & 3)` Case etiketine () değerlendiremez `case` `4` :  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Switch deyimleri](https://msdn.microsoft.com/library/fbede014-23bd-4ab1-8094-c8d9d9cb963a)
