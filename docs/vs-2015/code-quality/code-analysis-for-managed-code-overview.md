...
## <a name="in-source-suppression"></a>Kaynak gizleme bölümünde
 ...
 Uyarıları kaynak gizleme bölümünde özel öznitelikler kullanılarak uygulanır. Bir uyarıyı gizlemek için aşağıdaki örnekte gösterildiği gibi, öznitelik `SuppressMessage` özniteliği kaynak koda ekleyin:
