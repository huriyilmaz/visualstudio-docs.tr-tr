...
### <a name="comments"></a>Yorumlar
 Aşağıdaki örnek, öğesini döndürecek şekilde özelliğini değiştirerek ihlalin düzeltir <xref:System.Collections.ObjectModel.Collection%601?displayProperty=fullName> .
