...
Birçok geliştirme ve Visual Studio ALM yeni özellikler hakkında daha fazla bilgi için bkz: [TFS 2015 için Yenilikler](/azure/devops/server/whats-new#tfs-2015).
