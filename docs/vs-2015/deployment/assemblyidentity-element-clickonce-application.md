...
Bir dağıtımda dağıtılan uygulamayı tanımlar [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] .  
...
### <a name="description"></a>Açıklama  
 Aşağıdaki kod örneği `assemblyIdentity` bir uygulama bildiriminde bir öğe gösterir [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] . Bu kod örneği, [ClickOnce uygulama bildiriminde](../deployment/clickonce-application-manifest.md)sağlanmış daha büyük bir örneğin bir parçasıdır.  
