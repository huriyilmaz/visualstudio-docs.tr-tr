...
## <a name="example"></a>Örnek  
 Aşağıdaki kod örneği `InstallChecks` öğesi için ürün dosyasında kullanılan öğesini gösterir [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] .  
