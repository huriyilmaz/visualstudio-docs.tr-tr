...
## <a name="http-compression-issues"></a>HTTP sıkıştırma sorunları  
 ...
 IIS hakkında ayrıntılı yönergeler için bkz. [HTTP sıkıştırması için ek belge türleri belirtme](https://support.microsoft.com/kb/234497).  
