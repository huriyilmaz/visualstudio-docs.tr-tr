...
- Uygulamanın istemci bilgisayarda önkoşulları gerektirip gerektirmediğini belirleme.  
     ...
     Visual Studio 'dan dağıtılan [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] uygulamalar, dağıtımınız ile bir önkoşul yükleme Önyükleyicisi (Setup. exe) içerebilir. Bu izlenecek yol, [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] dağıtımı için gereken iki bildirimi oluşturur. [GenerateBootstrapper görevini](../msbuild/generatebootstrapper-task.md)kullanarak bir önkoşul önyükleyici oluşturabilirsiniz.  
...
1. [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] dağıtım dosyalarınızı depolayabileceğiniz bir dizin oluşturun.  
...
4. [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] veya Visual Studio komut istemi ' ni açın ve sürüm alt dizinine değiştirin.  
