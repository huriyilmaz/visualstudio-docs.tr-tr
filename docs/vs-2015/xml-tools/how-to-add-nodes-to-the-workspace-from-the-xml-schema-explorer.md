...
2. `PurchaseOrderType`XSD Gezgini içindeki düğüme sağ tıklayın. **Grafik görünümünde göster '** i seçin.
...
3. `purchaseOrder`Düğümü grafik görünümüne sürükleyin.
     ...
     `purchaseOrder`Düğüm ve düğüm, `PurchaseOrderType` Grafik görünümünün tasarım yüzeyinde birbirini izleyen bir şekilde görünür. İki düğüm `purchaseOrder` yeniden `PurchaseOrderType` çizildiğinden (öğe türü), aralarında bir ok çizilir.
