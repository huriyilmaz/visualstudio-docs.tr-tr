---
title: C# için geliştirme ortamını kullanma | Microsoft Docs
ms.date: 11/15/2016
...
Visual Studio tümleşik geliştirme ortamı (IDE), ortak bir kullanıcı arabirimi aracılığıyla kullanıma sunulan bir geliştirme araçları koleksiyonudur. Bazı araçlar diğer [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] dillerle paylaşılır ve C# derleyicisi gibi bazı araçlar Visual C# için benzersizdir. Bu konu, en önemli Visual C# araçlarına bağlantılar sağlar.
...
- [C ile çalışmaya başlama #](https://msdn.microsoft.com/library/d6ec050f-3956-4737-8030-a4fa3521d29f)
