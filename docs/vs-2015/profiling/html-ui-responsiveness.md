...
## <a name="run-the-html-ui-responsiveness-tool"></a><a name="RunningProfiler"></a> HTML UI yanıt verme aracı 'nı çalıştırın  
...
## <a name="isolate-an-issue"></a><a name="IsolateAnIssue"></a> Bir sorunu yalıtmak  
...
## <a name="analyze-data"></a><a name="AnalyzeData"></a> Verileri çözümleme  
...
### <a name="group-events-by-frame"></a><a name="GroupFrames"></a> Olayları çerçeveye göre Gruplandır  
 ...
 ![Üst düzey olayları çerçeveye göre Gruplandır](../profiling/media/js-htmlvizprofiler-frame-grouping-button.png "JS_HTMLVizProfiler_Frame_Grouping_Button")  
...
## <a name="save-a-diagnostic-session"></a><a name="SaveSession"></a> Tanılama oturumu Kaydet  
...
## <a name="profiler-event-reference"></a><a name="ProfilerEvents"></a> Profil Oluşturucu olay başvurusu  
...
## <a name="additional-information"></a><a name="Tips"></a> Ek bilgi  
