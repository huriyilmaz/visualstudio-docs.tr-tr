...
İkili dosyaları işaretlemek için VSInstr aracı kullanılır. Aşağıdaki sözdizimi kullanılarak çağrılır:  
...
|**Kapsam**|Kapsam İzleme gerçekleştirir. Bu, yalnızca şu seçeneklerle kullanılabilir: **verbose**, **OutputPath**, **exclude**ve **logfile**.|  
