...
---
# <a name="analyze-c-code-quality-of-store-apps-using-visual-studio-static-code-analysis"></a>Visual C++ Studio statik Kod analizini kullanarak Mağaza uygulamalarının kod kalitesini analiz etme
...
2. Proje özelliği sayfasında, **Kod Analizi** ' ni seçin ve ardından **derleme üzerinde C/C++ Kod analizini etkinleştir**' i seçin.
...
3. **Iletiyi bastırın** ve ardından **kaynak '** ı seçin.
   ...
   İletiyi gizleme, kod satırı için uyarıyı gösteren `#pragma(warning:`*Warnıngıd* `)` ekler.
...
## <a name="Warnings"></a>C++ kod analizi uyarıları
 Kod Analizi kod için C++ aşağıdaki uyarıları oluşturur:
