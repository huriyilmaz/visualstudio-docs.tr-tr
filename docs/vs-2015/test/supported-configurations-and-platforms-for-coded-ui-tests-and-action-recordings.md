...
|MFC|Kısmen desteklenir. Desteklenen özelliklerin ayrıntıları için aşağıdaki [Microsoft Web sitesine](http://go.microsoft.com/fwlink/?LinkId=206511) bakın.|
...
|Dynamics (Ax) 2012 işlemcisi|Eylem kaydı ve kayıttan yürütme kısmen desteklenir. Ayrıntılar için aşağıdaki [Microsoft Web sitesine](http://go.microsoft.com/fwlink/?LinkId=232677) bakın.|
|SAP|Desteklenmez.|
