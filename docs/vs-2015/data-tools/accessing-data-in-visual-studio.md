...
### <a name="net-languages"></a>.NET dilleri
 ...
 Özel ASP.NET ile ilgili veri erişim belgelerine bakın [verilerle çalışma](https://docs.microsoft.com/aspnet/web-forms/overview/presenting-and-managing-data/) ASP.NET sitesinde. ASP.NET MVC ile Entity Framework kullanan bir öğretici için bkz. [Entity Framework 6 Code MVC 5 kullanarak First ile çalışmaya başlama](https://docs.microsoft.com/aspnet/mvc/overview/getting-started/getting-started-with-ef-using-mvc/creating-an-entity-framework-data-model-for-an-asp-net-mvc-application).
...
### <a name="native-c"></a>Yerel C++
 ...
 Microsoft Azure depolamasıyla çalışmayı C++ programları kullanabileceğiniz [Microsoft Azure depolama istemci](https://www.nuget.org/packages/wastorage).

#### <a name="data-modeling"></a>Veri modelleme
 Visual Studio C++ için ORM katman sağlamaz.  [ODBC](https://www.codesynthesis.com/products/odb/) C++ için popüler bir açık kaynak ORM olduğu.
...
## <a name="related-topics"></a>İlgili konular
 ...
 [WCF Veri Hizmetleri 4.5](https://msdn.microsoft.com/library/73d2bec3-7c92-4110-b905-11bb0462357a) nasıl kullanılacağını açıklar [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] web veya intranet uygulayan veri hizmetlerini dağıtmanızı [açık veri Protokolü (OData)](https://go.microsoft.com/fwlink/?LinkID=182204).
