...
## <a name="related-topics"></a>İlgili konular
 ...
 [WCF Veri Hizmetleri 4.5](https://msdn.microsoft.com/library/73d2bec3-7c92-4110-b905-11bb0462357a) nasıl kullanılacağını açıklar [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] web veya intranet uygulayan veri hizmetlerini dağıtmanızı [açık veri Protokolü (OData)](https://www.odata.org/).
