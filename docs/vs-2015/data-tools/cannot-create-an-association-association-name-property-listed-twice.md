---
title: Bir ilişki &lt;association adı oluşturulamıyor &gt;-Özellik iki kez listelendi | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Ayrıca Bkz.
 [Visual Studio 'da LINQ to SQL araçları](https://msdn.microsoft.com/library/a57e82d5-f7e4-4894-8add-3d9ba4fce186) [nasıl yapılır: LINQ to SQL sınıfları (o/r Designer) arasında ilişkilendirme (ilişki) oluşturma](../data-tools/how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md) [Izlenecek yol: LINQ to SQL sınıfları oluşturma (o-r Designer)](https://msdn.microsoft.com/library/35aad4a4-2e8a-46e2-ae09-5fbfd333c233) [LINQ to SQL](https://msdn.microsoft.com/library/73d13345-eece-471a-af40-4cc7a2f11655)
