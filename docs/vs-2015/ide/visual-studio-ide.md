...
## <a name="visual-studio-setup"></a>Visual Studio Kurulumu
 Visual Studio'nun hangi sürümünün size uygun olduğunu bulabilirsiniz [Visual Studio sürümleri](https://visualstudio.microsoft.com/vs/).

 Visual Studio 2015 buradan indirip yükleyebileceğiniz [Visual Studio indirmeleri](https://www.visualstudio.com/downloads/download-visual-studio-vs.aspx). Yükleme işlemi hakkında daha fazla bilgi edinmek istiyorsanız bkz [yükleme Visual Studio 2015](../install/install-visual-studio-2015.md).
