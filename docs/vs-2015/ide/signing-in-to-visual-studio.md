...
- Visual Studio Dev Essentials programından ücretsiz yazılım, eğitim, destek ve daha fazlasını içeren çok çeşitli **avantajlar için erişim verir** . Daha fazla bilgi için bkz. [Visual Studio Dev Essentials](https://visualstudio.microsoft.com/dev-essentials/) .
 ...
 **Dosya &#124; hesap ayarları ' nda,** Visual Studio profiliniz ve lisansınız hakkındaki bilgileri görebilir ve güncelleştirebilirsiniz. Hesap adınız, Avatar resminiz veya e-posta adresiniz gibi profil bilgilerinizi düzenlemek için:
