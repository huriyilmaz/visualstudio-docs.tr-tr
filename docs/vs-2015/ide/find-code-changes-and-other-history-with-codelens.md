...
## <a name="FindReferences"></a>Kodunuza başvuruları bulma
 Şunlar gerekir:
...
- Visual C# .net veya Visual Basic .NET kodu
  ...
  **Başvurular** göstergesini seçin (**alt + 2**). **0 başvuru**görürseniz, Visual C# veya Visual Basic kodundan bir başvuruya sahip olursunuz. Bu, XAML ve ASPX dosyaları gibi diğer öğelerden başvuruları içermez.
  ...
  ![Kod haritasında &#45; CodeLens başvuruları](../ide/media/codelensmappedreferences.png "CodeLensMappedReferences")

## <a name="FindCodeHistory"></a>Kodunuzun geçmişini ve bağlantılı öğelerini bulun
...
### <a name="find-changes-in-your-code"></a>Kodunuzda değişiklik bulun
 Kod öğesi düzeyi göstergelerinde C# veya Visual Basic kodunuzun ve yaptıkları değişikliklerin kim tarafından değiştirildiğini bulun. Team Foundation Server veya Visual Studio Team Services içinde Team Foundation sürüm denetimi 'ni (TFVC) kullandığınızda gördüğünüz şeydir.
 ...
 Pencerenin alt kısmındaki dosya düzeyi göstergelerinde dosyanın tamamına C# (ve Visual Basic dosyalar hariç) ilişkin değişiklikleri bulur.
...
#### <a name="find-when-changes-got-merged"></a>Değişikliklerin ne zaman birleştirildiğini bul
 ...
 ![Dallar arasında &#45; kod lens birleştirilmiş değişiklikleri](../ide/media/codelensbranchmergedconceptual.png "Codelensbranchbirleştirilen kavramsal")

 Örneğin, Ana daldaki kodunuz artık geliştirici dalında hata düzeltmesine sahiptir:

 ![Dallar arasında &#45; CodeLens birleştirilmiş chagnes](../ide/media/codelensbranchmergedscreenshot.png "Codelensbranchbirleştiriekran görüntüsü")
...
|![Üst daldan &#45; CodeLens değişikliği simgesi](../ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|Üst dal|
|![CodeLens: alt dal simgesinden değiştirme](../ide/media/codelensbranchchildicon.png "CodeLensBranchChildIcon")|Bir alt dal|
|![Eş dalı &#45; simgesinden CodeLens değişikliği](../ide/media/codelensbranchpeericon.png "Codelensbranchpeerıcon")|Bir eş dalı|
|![Daha fazla &#45; daldan kod lens değişikliği simgesi](../ide/media/codelensbranchfurtherawayicon.png "Codelensbranchmobilyatherawayıcon")|Üst, alt veya eşten daha fazla bir dal|
...
### <a name="find-linked-work-items"></a>Bağlantılı iş öğelerini bul
 ![CodeLens &#45; belirli bir kod için iş öğelerini bul](../ide/media/codelensworkitems.png "Codelensworkıtems")
...
### <a name="find-linked-bugs"></a>Bağlantılı hataları bulma
 ![Değişiklik kümelerine &#45; bağlı CodeLens bulma hataları](../ide/media/codelensbugschangesets.png "Codelensbugsdeğişiklik kümeleri")
...
## <a name="FindRunUnitTests"></a>Kodunuz için birim testlerini bulma
 Test Gezgini 'ni açmadan kodunuz için var olan birim testleri hakkında daha fazla bilgi edinin. Şunlar gerekir:
...
2. Bu kod için testleri gözden geçirin (**alt + 3**).
     ...
     ![CodeLens &#45; kod düzenleyicisinde test durumu seçme](../ide/media/codelenschoosetestindicator.png "CodeLensChooseTestIndicator")

3. Bir uyarı simgesi görürseniz, ![kod lens &#45; birim testleri henüz uyarı çalıştırmadıysa](../ide/media/codelenstestwarningicon.png "Codelenstestwarningıcon"), testleri çalıştırın.
...
### <a name="ChangeOrTurnOff"></a>S: CodeLens 'i Nasıl yaparım? açın mi? Ya da hangi göstergeleri görmek istediğinizi seçin
 ...
 ![CodeLens &#45; kapatma göstergeleri kapalı veya açık](../ide/media/codelensturnoffonindicatorsfromcode.png "Codelensturnoffonındicatorsfromcode")
...
### <a name="NoIndicators"></a>S: CodeLens nerede?
 Y **:** CodeLens, Visual C# .net 'te ve yöntem, sınıf, Dizin Oluşturucu ve özellik düzeyinde .net kodu Visual Basic görünür. CodeLens, diğer tüm dosya türleri için dosya düzeyinde görünür.
...
### <a name="NoLync"></a>S: Lync veya Skype göstergelerini neden görmüyorum?
 ...
 ![Posta ile &#45; CodeLens kişi değişiklik kümesi sahibi](../ide/media/codelenscodesendmailchangesetnolync1.png "CodeLensCodeSendMailChangesetNoLync1")
...
### <a name="q-how-do-i-change-the-font-and-color-for-codelens"></a>S: Nasıl yaparım? CodeLens 'in yazı tipini ve rengini değiştirmek istiyor musunuz?
 ...
 ![CodeLens &#45; değişiklik yazı tipi ve renk ayarları](../ide/media/codelensoptionsfontscolorssettings.png "Codelensoptions Fontscolorssettings")
...
### <a name="q-can-i-move-the-codelens-heads-up-display"></a>S: CodeLens ekran göstergesi görüntüsünü taşıyabilir miyim?
 Y **:** Evet, CodeLens 'i pencere olarak yerleştirmek için ![bir pencere olarak &#45; CodeLens Dock](../ide/media/codelensdockwindow.png "CodeLensDockWindow") ' u seçin.
...
- **Başvurular**: Bu gösterge, kod değiştiğinde otomatik olarak güncelleştirilir. Bu göstergeyi ayrı bir pencere olarak yuvalandıysanız, göstergeyi burada el ile yenileyin:
     ...
     ![Pencere olarak &#45; CodeLens yerleştirme](../ide/media/codelensviewreferencesdocked.png "Codelensviewreferencesyerleştirildi")
