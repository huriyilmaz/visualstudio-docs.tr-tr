...
|Bul|SHIFT + enter|Odağı önceki öğeye değiştir.|
...
|Alan|**Bekleyen değişiklikler** listesine bir öğe ekleyin.|
|Tab|Odağı **bekleyen değişiklikler** listesine değiştirin.|
|Yukarı ok ve aşağı ok|**Bekleyen değişiklikler** listesinde ilerleyin.|
|Alan|**Bekleyen değişiklikler** listesinden bir öğeyi kaldırır.|
