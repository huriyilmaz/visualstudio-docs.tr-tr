...
ms.locfileid: "72657674"
---
# <a name="keyboard-environment-options-dialog-box"></a>Klavye, Ortam, Seçenekler İletişim Kutusu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Klavye eşlemelerini ayarlamak için bu sayfayı kullanın. Eşlemeler hakkında daha fazla bilgi için bkz. [klavye kısayollarını tanımlama ve özelleştirme](../../ide/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md).
