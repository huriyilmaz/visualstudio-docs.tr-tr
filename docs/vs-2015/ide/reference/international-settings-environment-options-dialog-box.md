...
Uluslararası Ayarlar sayfası, makinenizde tümleşik geliştirme ortamının (IDE) birden çok dil sürümüne sahip olduğunuzda varsayılan dili değiştirmenize izin verir. Bu iletişim kutusuna, **Araçlar** menüsünden **Seçenekler** ' i ve ardından **ortam** klasöründen **Uluslararası ayarlar** ' ı seçerek erişebilirsiniz. Bu sayfa listede görünmezse, **Seçenekler** iletişim kutusunda **tüm ayarları göster** ' i seçin.
