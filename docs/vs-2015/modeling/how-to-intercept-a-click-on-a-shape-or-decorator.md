---
title: 'Nasıl yapılır: bir şekle veya Dekoratcıyı bir tıklama için kesme | Microsoft Docs'
ms.date: 11/15/2016
...
4. Aşağıdaki kısmi sınıf tanımını ekleyerek, sınıflarınızdaki şekeshapefields metodunu geçersiz kılın.
...
## <a name="see-also"></a>Ayrıca Bkz.
 [Dekoratörler](../modeling/properties-of-decorators.md) [için değişiklikleri yanıtlama ve yayma](../modeling/responding-to-and-propagating-changes.md) özellikleri
