...
## <a name="see-also"></a>Ayrıca Bkz.
 Oluşturulan API [alana özgü dil Araçları sözlüğü](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa) [Içindeki etki alanı ilişkileri](../misc/domain-relationships-in-the-generated-api.md)
