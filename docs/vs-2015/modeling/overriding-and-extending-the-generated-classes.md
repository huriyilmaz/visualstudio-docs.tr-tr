---
title: Oluşturulan sınıfları geçersiz kılma ve genişletme | Microsoft Docs
ms.date: 11/15/2016
...
### <a name="overriding-methods-in-a-partial-class"></a>Kısmi sınıftaki yöntemleri geçersiz kılma
