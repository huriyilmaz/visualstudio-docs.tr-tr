...
## <a name="control-blocks"></a>Denetim blokları
 Denetim blokları, şablonları dönüştürmek için kullanılan program kodunun bölümleridir. Varsayılan dil C# ' dir, ancak kullanmak için [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] Bu yönergeyi dosyanın başına yazabilirsiniz:
