...
İçinde Alana Özgü Dil Araçları (DSL araçları) çözümünü ilk kez açtığınızda [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] , Kullanıcı arabirimi aşağıdaki resme benzeyecektir.
