...
Herhangi bir bilgisayarda özel bir yönerge işlemcisi kullanmak için [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] , bu konuda açıklanan yöntemlerden birini kullanarak kaydetmeniz gerekir.
...
- Bir kayıt defteri anahtarı ayarlayın. Bu yöntemde, yönerge işlemcisi için bir kayıt defteri girdisini ekleyin.
  ...
  Bu yöntemlerden birini yalnızca, veya ' de metin şablonunuzu dönüştürmek istiyorsanız kullanmanız gerekir [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] . Kendi uygulamanızda özel bir ana bilgisayar kullanıyorsanız, her yönerge için yönerge işlemcisi bulmak özel ana bilgisayarınızın sorumluluğundadır.
...
1. İçinde bir VSıX projesi oluşturun [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .

    - **Yeni proje** iletişim kutusunda **Visual Basic** veya **Visual C#**' yi genişletin, ardından **genişletilebilirlik**' i genişletin. **VSIX projesi**' ne tıklayın.
...
3. .vsix dosyasına çift tıklatın. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]Uzantı Yükleyicisi görüntülenir.

4. Yeniden başlatın [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] . Artık, özel yönerge işlemcisine başvuran yönergeleri içeren metin şablonlarını çalıştırmak mümkün olacaktır. Her yönerge bu şekildedir:
...
1. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] **Araçlar** menüsünde **Uzantı Yöneticisi**' ne tıklayın.
...
2. Regedit içinde şuraya gidin:
    ...
    **HKEY_LOCAL_MACHINE \SOFTWARE\Microsoft\VisualStudio \\ \* . 0 \ Texttemplating\directiveiþlemcileri**
    ...
    ' In deneysel sürümüne yönerge işlemcisini yüklemek isterseniz " [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 11,0" sonrasına "exp" ekleyin.
