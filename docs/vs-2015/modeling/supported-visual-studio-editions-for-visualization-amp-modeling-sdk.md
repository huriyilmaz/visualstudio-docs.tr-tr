...
Aşağıda, [!INCLUDE[dsl](../includes/dsl-md.md)] yazma ve dağıtım ortamlarında ile desteklenen Visual Studio sürümleri listelenmiştir. Bu sürümler hakkında daha fazla bilgi için bkz. Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [Geliştirici Merkezi](https://msdn.microsoft.com/vstudio/products/).
...
## <a name="deployment-editions"></a>Dağıtım sürümleri
 [!INCLUDE[dsl](../includes/dsl-md.md)] , oluşturduğunuz alana özgü dillerin dağıtımı için aşağıdaki konfigürasyonları destekler:
