...
Eşzamanlılık görselleştiricisi komut satırı yardımcı programını (*CVCollectionCmd. exe*), bunları Visual Studio Için eşzamanlılık görselleştiricisi içinde görüntüleyebilmeniz için komut satırından izleme toplamak üzere kullanabilirsiniz. Araçlar, Visual Studio yüklü olmayan bilgisayarlarda kullanılabilir.
...
| MajorVersion | Yapılandırma dosyasının ana sürümünü belirtir. | [!INCLUDE[vs_dev11_long](../data-tools/includes/vs_dev11_long_md.md)] projeleri için 1 olmalıdır. 1 değilse, yardımcı program çalışmaz. |
| MinorVersion | Yapılandırma dosyasının ikincil sürümünü belirtir. | [!INCLUDE[vs_dev11_long](../data-tools/includes/vs_dev11_long_md.md)] projeleri için 0 olmalıdır. 0 değilse, yardımcı program çalışmaz. |
