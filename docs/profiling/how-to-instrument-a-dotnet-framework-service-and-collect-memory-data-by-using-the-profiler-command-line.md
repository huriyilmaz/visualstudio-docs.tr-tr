...
description: .NET Framework hizmeti için bellek ayırma ve nesne yaşam süresi verilerini toplamak üzere Visual Studio Profil Oluşturma Araçları komut satırı araçlarının nasıl kullanılacağını öğrenin.
