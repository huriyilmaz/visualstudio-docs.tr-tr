...
Bu makalede, profilleyiciyi çalışan bir Visual Studio Profil Oluşturma Araçları (istemci) uygulamasına eklemek ve bellek verilerini toplamak için .NET Framework komut satırı araçlarının nasıl kullanımı açıklanmıştır.
...
Profil oluşturma oturumunu sona erdirmak için profil oluşturma işleminin tüm profil oluşturma işlemlerinden ayrılması ve profil oluşturmanın açıkça kapatılmış olması gerekir. Çoğu durumda, bir oturumun sonunda profil oluşturma ortam değişkenlerini temizlemenizi öneririz.
...
2. Profil oluşturma ortam değişkenlerini başlatma. Şunu yazın:
    ...
    - **/samplegc** ve **/samplegclife** seçenekleri, yalnızca bellek ayırma verilerini mi yoksa hem bellek ayırma hem de nesne yaşam süresi verilerini mi toplaymak için belirtebilirsiniz. Bir ve yalnızca bir seçenek belirtilmelidir.
