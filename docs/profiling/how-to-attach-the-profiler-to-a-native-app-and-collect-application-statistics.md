...
description: Profiler 'ı çalışan yerel bir tek başına uygulamaya eklemek ve örnekleme yöntemini kullanarak performans istatistikleri almak için Visual Studio Profil Oluşturma Araçları kullanın.
