...
`MarkProfile` yöntemi içine bir profil işareti ekler. *VSP* dosyası. Eklenecek işaret için `MarkProfile` işlevi içeren iş parçacığının profil oluşturma açık olmalıdır.
