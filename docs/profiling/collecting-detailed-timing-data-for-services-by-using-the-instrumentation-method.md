...
description: komut satırından izleme yöntemini kullanarak Windows hizmetleri için ayrıntılı performans verileri nasıl toplayacağınızı öğrenin.
...
|**Web uygulamalarının profilini ASP.NET**|-   [İzleme kullanarak ayrıntılı zamanlama verileri toplama](../profiling/collecting-detailed-timing-data-aspnet-profiler-instrumentation-method.md)|
