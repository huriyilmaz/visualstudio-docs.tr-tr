...
Bu makalede, bir ASP.NET uygulamasına Profiler eklemek ve işlem ve iş parçacığı eşzamanlılık verilerini toplamak için [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Profil Oluşturma Araçları komut satırı araçlarının nasıl kullanılacağı açıklanır.
...
3. Aşağıdaki komutu yazarak profil oluşturucuyu ASP.NET Worker işlemine iliştirin:**VSPerfCmd/Attach:** `PID` [ **/targetclr:** `Version`]
