...
description: Tek başına bir uygulamanın .NET Framework bileşeni için zamanlama verilerini toplamak üzere Visual Studio Profil Oluşturma Araçları komut satırı araçlarının nasıl kullanılacağını öğrenin.
