...
![Olay Görüntüleyicisi İzleme](../profiling/media/eventviewertrace.png "Olay Görüntüleyicisi Izleme")
...
![HTML Kullanıcı Arabirimi Yanıt Hızı profil oluşturma aracı](../profiling/media/diaghtmlresp.png "Diabir Mlyanıt")
::: moniker-end
