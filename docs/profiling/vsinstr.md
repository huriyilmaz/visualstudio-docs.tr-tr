...
description: İkili dosyaları ve diğer çeşitli VSInstr araç seçeneklerini işaretlemek için VSInstr aracının nasıl kullanıldığını öğrenin.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
